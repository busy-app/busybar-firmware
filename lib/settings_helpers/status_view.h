 ...
 *
 * Supports static image (.image) paths and animated icons (.anim).
 * Passing a path ending in ".anim" activates the animation player;
 * other paths are treated as static image sources.
 *
