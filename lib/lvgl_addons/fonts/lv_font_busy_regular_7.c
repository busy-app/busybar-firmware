 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --font ..\..\assets\shared\fonts\ttf\busy_regular_7.ttf -o ..\..\lib\lvgl_addons\fonts\lv_font_busy_regular_7.c --bpp 1 --size 16 --no-compress --format lvgl --range 0-65535
 ******************************************************************************/
