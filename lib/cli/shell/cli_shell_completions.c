...
typedef enum {
    ...
    CliShellCompletionsActionFullRerender,
...
void cli_shell_completions_render(
    ...
    if(action == CliShellCompletionsActionOpen) {
        ...
        cli_shell_completions_render(completions, CliShellCompletionsActionFullRerender);

    } else if(action == CliShellCompletionsActionFullRerender) {
        printf("\n\r");
        size_t position = 0;
        for
...
void cli_shell_completions_full_rerender(CliShellCompletions* completions) {
