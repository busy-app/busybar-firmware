...
bool bh1730_init(FuriHalI2cBusHandle* handle) {
    ...
    do {
        ...
        if(!furi_hal_i2c_write_reg_8(
               handle,
               BH1730_I2C_ADDRESS,
               BH1730_COMMAND_WRITE | BH1730_REG_TIMING,
               BH1730_ITIME_VAL,
               BH1730_I2C_TIMEOUT))
            break;
        ...
        if(!furi_hal_i2c_write_reg_8(
               handle,
               BH1730_I2C_ADDRESS,
               BH1730_COMMAND_WRITE | BH1730_REG_GAIN,
               *(uint8_t*)&gain,
               BH1730_I2C_TIMEOUT))
            break;
...
static bool bh1730_read_raw_data(FuriHalI2cBusHandle* handle, uint16_t* value, uint8_t reg) {
    ...
    bool read_success = furi_hal_i2c_read_mem(
        handle, BH1730_I2C_ADDRESS, BH1730_COMMAND_WRITE | reg, data_buf, 2, BH1730_I2C_TIMEOUT);
    furi_hal_i2c_release(handle);
...
bool bh1730_read_lux(FuriHalI2cBusHandle* handle, float* value) {
    ...
    bool read_success = furi_hal_i2c_read_mem(
        handle,
        BH1730_I2C_ADDRESS,
        BH1730_COMMAND_WRITE | BH1730_REG_DATA0LOW,
        data_buf,
        4,
        BH1730_I2C_TIMEOUT);
    furi_hal_i2c_release(handle);
