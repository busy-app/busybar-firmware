 ...
 *
 */
#define CHIP_VERSION_CODE_DECODE_MAJOR(code) \
    (((code) >> _CHIP_VERSION_CODE_MAJOR_SHIFT) & _CHIP_VERSION_CODE_MAJOR_MASK)
 ...
 *
 */
#define CHIP_VERSION_CODE_DECODE_MINOR(code) \
    (((code) >> _CHIP_VERSION_CODE_MINOR_SHIFT) & _CHIP_VERSION_CODE_MINOR_MASK)
 ...
 *
 */
#define CHIP_VERSION_CODE_DECODE_PATCH(code) \
    (((code) >> _CHIP_VERSION_CODE_PATCH_SHIFT) & _CHIP_VERSION_CODE_PATCH_MASK)
 ...
 *
 */
#define CHIP_VERSION_CODE \
    CHIP_VERSION_CODE_ENCODE(CHIP_VERSION_MAJOR, CHIP_VERSION_MINOR, CHIP_VERSION_PATCH)
