...
#define CHIP_DEVICE_CONFIG_MAX_EVENT_QUEUE_SIZE 32
...
#define CHIP_DEVICE_CONFIG_ICD_SLOW_POLL_INTERVAL \
    chip::System::Clock::Milliseconds32(SL_TRANSPORT_IDLE_INTERVAL)
#endif // CHIP_DEVICE_CONFIG_ICD_SLOW_POLL_INTERVAL

#ifndef CHIP_DEVICE_CONFIG_ICD_FAST_POLL_INTERVAL
#define CHIP_DEVICE_CONFIG_ICD_FAST_POLL_INTERVAL \
    chip::System::Clock::Milliseconds32(SL_TRANSPORT_ACTIVE_INTERVAL)
#endif // CHIP_DEVICE_CONFIG_ICD_FAST_POLL_INTERVAL
#endif // SL_ICD_ENABLED

// Reduce noise in log output
#define CHIP_DISPATCH_EVENT_LONG_DISPATCH_TIME_WARNING_THRESHOLD_MS 0
