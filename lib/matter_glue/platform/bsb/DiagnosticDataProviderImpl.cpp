...
CHIP_ERROR
DiagnosticDataProviderImpl::GetWiFiPacketMulticastRxCount(uint32_t& packetMulticastRxCount) {
    wfx_wifi_scan_ext_t extra_info;
    int32_t err = wfx_get_ap_ext(&extra_info);
    if(err == 0) {
...
CHIP_ERROR
DiagnosticDataProviderImpl::GetWiFiPacketMulticastTxCount(uint32_t& packetMulticastTxCount) {
    wfx_wifi_scan_ext_t extra_info;
    int32_t err = wfx_get_ap_ext(&extra_info);
    if(err == 0) {
...
CHIP_ERROR
DiagnosticDataProviderImpl::GetWiFiPacketUnicastRxCount(uint32_t& packetUnicastRxCount) {
    wfx_wifi_scan_ext_t extra_info;
    int32_t err = wfx_get_ap_ext(&extra_info);
    if(err == 0) {
...
CHIP_ERROR
DiagnosticDataProviderImpl::GetWiFiPacketUnicastTxCount(uint32_t& packetUnicastTxCount) {
    wfx_wifi_scan_ext_t extra_info;
    int32_t err = wfx_get_ap_ext(&extra_info);
    if(err == 0) {
