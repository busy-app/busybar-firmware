...
class ProtectedFieldsOcelot(ProtectedFieldsBase):
    ...
    PTE_PROTECTED_FIELD_DICT = {
        ...
        'MODEM_IRCAL_IRCALEN': 'cal',
        'RAC_PGACTRL_PGAPOWERMODE': 'cal',
        'RAC_LNAMIXTRIM2_LNAMIXLOWCUR': 'cal',
        'SYNTH_LPFCTRL2TX_LPFINCAPTX': 'cal',
        'SYNTH_LPFCTRL2RX_LPFINCAPRX': 'cal',
    ...
    RAIL_PROTECTED_FIELDS = [
        ...
        'RAC_IFADCPLLDCO_IFADCPLLDCOTEMPADJ',
    ...
    RAIL_PROTECTED_FIELD_EXCEPTIONS = [
        ...
        'RAC_EN_EN',
        'RAC_LNAMIXTRIM3_LNAMIXIBIASADJP',
        'RAC_LNAMIXTRIM3_LNAMIXIBIASADJN',
        'RAC_PGACAL_PGAOFFPCALQ',
        'RAC_PGACAL_PGAOFFPCALI',
        'RAC_PGACAL_PGAOFFNCALQ',
        'RAC_PGACAL_PGAOFFNCALI',
        'MODEM_IRCALCOEFWR0_CRVWD',
        'MODEM_IRCALCOEFWR0_CIVWD',
        'MODEM_IRCALCOEFWR1_CRVWD',
        'MODEM_IRCALCOEFWR1_CIVWD',
        'RAC_LNAMIXTRIM2_LNAMIXLOWCUR',
        'MODEM_IRCAL_IRCALEN',
        'RAC_AUXADCTRIM_AUXADCTSENSETRIMVBE2',
        'RAC_PATRIM1_TXTRIMHPAVPCAS',
        'RAC_PATRIM2_TXTRIMCLKGENDUTYP',
        'RAC_PATRIM2_TXTRIMCLKGENDUTYN',
    ]