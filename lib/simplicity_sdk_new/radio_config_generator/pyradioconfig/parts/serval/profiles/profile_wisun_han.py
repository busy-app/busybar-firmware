...
class ProfileWisunHanServal(ProfileWisunHanJumbo):
    ...
    def build_register_profile_outputs(self, model, profile):
        # Overriding this method to include modem regs for Serval
        family = self._family
    ...
    def _fixed_wisun_vars(self, model):
        ...
        #Add deviation tolerance and xtal error for Serval
    ...
    def _fixed_wisun_thresholds(self, model):
        #No hard-coded thresholds on Serval
        pass

    def _fixed_wisun_agc(self, model):
        #No hard-coded AGC settings on Serval
        pass

    def _fixed_wisun_fec(self, model):
        # We have an optional Profile Input for fec_tx_enable on Serval
        pass
