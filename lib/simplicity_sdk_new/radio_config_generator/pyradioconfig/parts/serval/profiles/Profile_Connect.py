from pyradioconfig.parts.serval.profiles.Profile_Base import Profile_Base_Serval
...
class Profile_Connect_Serval(Profile_Base_Serval):
    ...
    def buildProfileModel(self, model):
        ...
        profile = super(Profile_Connect_Serval, self).buildProfileModel(model)
