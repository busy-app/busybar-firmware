from pyradioconfig.parts.panther.phys.Phys_Studio_BLE import PhysStudioBLEPanther


class PhysStudioBLELynx(PhysStudioBLEPanther):
    ...
    def PHY_Bluetooth_2M_prod(self, model, phy_name=None):
        ...
        phy.profile_inputs.rail_tx_power_max.value = [-1] * 40
        phy.profile_inputs.rail_tx_power_max.value[34] = 300
        ...
        phy.profile_inputs.rail_tx_power_max.value[38] = 58
        phy.profile_inputs.rail_tx_power_max.value[39] = 300
