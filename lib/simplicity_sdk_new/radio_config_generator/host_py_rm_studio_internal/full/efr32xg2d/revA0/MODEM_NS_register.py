...
class RM_Register_MODEM_NS_TRECSCFG(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DSAPMCNTGEN = RM_Field_MODEM_NS_TRECSCFG_DSAPMCNTGEN(self)
        self.zz_fdict['DSAPMCNTGEN'] = self.DSAPMCNTGEN
        self.MINCOSTVALESCEN = RM_Field_MODEM_NS_TRECSCFG_MINCOSTVALESCEN(self)
        self.zz_fdict['MINCOSTVALESCEN'] = self.MINCOSTVALESCEN
        self.__dict__['zz_frozen'] = True
