...
class RM_Field_MODEM_NS_TRECSCFG_DSAPMCNTGEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_TRECSCFG_DSAPMCNTGEN, self).__init__(register,
            'DSAPMCNTGEN', 'MODEM_NS.TRECSCFG.DSAPMCNTGEN', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_TRECSCFG_MINCOSTVALESCEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_TRECSCFG_MINCOSTVALESCEN, self).__init__(register,
            'MINCOSTVALESCEN', 'MODEM_NS.TRECSCFG.MINCOSTVALESCEN', 'read-write',
            u"",
            26, 1)
        self.__dict__['zz_frozen'] = True
