...
class RM_Field_MODEM_NS_CF_DISABLEHALFBIT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CF_DISABLEHALFBIT, self).__init__(register,
            'DISABLEHALFBIT', 'MODEM_NS.CF.DISABLEHALFBIT', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_SICCATIMERCTRL_CCATIMEREN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SICCATIMERCTRL_CCATIMEREN, self).__init__(register,
            'CCATIMEREN', 'MODEM_NS.SICCATIMERCTRL.CCATIMEREN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SICCATIMERCTRL_CCATIMERTGT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SICCATIMERCTRL_CCATIMERTGT, self).__init__(register,
            'CCATIMERTGT', 'MODEM_NS.SICCATIMERCTRL.CCATIMERTGT', 'read-write',
            u"",
            1, 15)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_FASTCWDETECTEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_FASTCWDETECTEN, self).__init__(register,
            'FASTCWDETECTEN', 'MODEM_NS.SIFASTDETECTCTRL.FASTCWDETECTEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_FASTSUPERCHIPEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_FASTSUPERCHIPEN, self).__init__(register,
            'FASTSUPERCHIPEN', 'MODEM_NS.SIFASTDETECTCTRL.FASTSUPERCHIPEN', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_FASTNARROWPULSEEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_FASTNARROWPULSEEN, self).__init__(register,
            'FASTNARROWPULSEEN', 'MODEM_NS.SIFASTDETECTCTRL.FASTNARROWPULSEEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_EYEOPENINGMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_EYEOPENINGMODE, self).__init__(register,
            'EYEOPENINGMODE', 'MODEM_NS.SIFASTDETECTCTRL.EYEOPENINGMODE', 'read-write',
            u"",
            3, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_CWDETECTSTARTWINDOW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_CWDETECTSTARTWINDOW, self).__init__(register,
            'CWDETECTSTARTWINDOW', 'MODEM_NS.SIFASTDETECTCTRL.CWDETECTSTARTWINDOW', 'read-write',
            u"",
            5, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_CWDETECTTHRESHOLD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_CWDETECTTHRESHOLD, self).__init__(register,
            'CWDETECTTHRESHOLD', 'MODEM_NS.SIFASTDETECTCTRL.CWDETECTTHRESHOLD', 'read-write',
            u"",
            9, 7)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_SUPERCHIPSTARTWINDOW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_SUPERCHIPSTARTWINDOW, self).__init__(register,
            'SUPERCHIPSTARTWINDOW', 'MODEM_NS.SIFASTDETECTCTRL.SUPERCHIPSTARTWINDOW', 'read-write',
            u"",
            16, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_NPULSEFIXEDTHRESHOLD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_NPULSEFIXEDTHRESHOLD, self).__init__(register,
            'NPULSEFIXEDTHRESHOLD', 'MODEM_NS.SIFASTDETECTCTRL.NPULSEFIXEDTHRESHOLD', 'read-write',
            u"",
            20, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_NPULSETHRESHADJEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_NPULSETHRESHADJEN, self).__init__(register,
            'NPULSETHRESHADJEN', 'MODEM_NS.SIFASTDETECTCTRL.NPULSETHRESHADJEN', 'read-write',
            u"",
            21, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SIFASTDETECTCTRL_NPULSETHRESHADJ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SIFASTDETECTCTRL_NPULSETHRESHADJ, self).__init__(register,
            'NPULSETHRESHADJ', 'MODEM_NS.SIFASTDETECTCTRL.NPULSETHRESHADJ', 'read-write',
            u"",
            25, 3)
        self.__dict__['zz_frozen'] = True
