...
class RM_Peripheral_MODEM_S(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.SICCATIMERCTRL = RM_Register_MODEM_S_SICCATIMERCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['SICCATIMERCTRL'] = self.SICCATIMERCTRL
        self.SIFASTDETECTCTRL = RM_Register_MODEM_S_SIFASTDETECTCTRL(self.zz_rmio, self.zz_label)
