...
class RM_Register_MODEM_S_CF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DISABLEHALFBIT = RM_Field_MODEM_S_CF_DISABLEHALFBIT(self)
...
class RM_Register_MODEM_S_SICCATIMERCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_SICCATIMERCTRL, self).__init__(rmio, label,
            0xb0214000, 0x12C,
            'SICCATIMERCTRL', 'MODEM_S.SICCATIMERCTRL', 'read-write',
            u"",
            0x00000000, 0x0000FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.CCATIMEREN = RM_Field_MODEM_S_SICCATIMERCTRL_CCATIMEREN(self)
        self.zz_fdict['CCATIMEREN'] = self.CCATIMEREN
        self.CCATIMERTGT = RM_Field_MODEM_S_SICCATIMERCTRL_CCATIMERTGT(self)
        self.zz_fdict['CCATIMERTGT'] = self.CCATIMERTGT
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_SIFASTDETECTCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_SIFASTDETECTCTRL, self).__init__(rmio, label,
            0xb0214000, 0x130,
            'SIFASTDETECTCTRL', 'MODEM_S.SIFASTDETECTCTRL', 'read-write',
            u"",
            0x00000000, 0x0FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.FASTCWDETECTEN = RM_Field_MODEM_S_SIFASTDETECTCTRL_FASTCWDETECTEN(self)
        self.zz_fdict['FASTCWDETECTEN'] = self.FASTCWDETECTEN
        self.FASTSUPERCHIPEN = RM_Field_MODEM_S_SIFASTDETECTCTRL_FASTSUPERCHIPEN(self)
        self.zz_fdict['FASTSUPERCHIPEN'] = self.FASTSUPERCHIPEN
        self.FASTNARROWPULSEEN = RM_Field_MODEM_S_SIFASTDETECTCTRL_FASTNARROWPULSEEN(self)
        self.zz_fdict['FASTNARROWPULSEEN'] = self.FASTNARROWPULSEEN
        self.EYEOPENINGMODE = RM_Field_MODEM_S_SIFASTDETECTCTRL_EYEOPENINGMODE(self)
        self.zz_fdict['EYEOPENINGMODE'] = self.EYEOPENINGMODE
        self.CWDETECTSTARTWINDOW = RM_Field_MODEM_S_SIFASTDETECTCTRL_CWDETECTSTARTWINDOW(self)
        self.zz_fdict['CWDETECTSTARTWINDOW'] = self.CWDETECTSTARTWINDOW
        self.CWDETECTTHRESHOLD = RM_Field_MODEM_S_SIFASTDETECTCTRL_CWDETECTTHRESHOLD(self)
        self.zz_fdict['CWDETECTTHRESHOLD'] = self.CWDETECTTHRESHOLD
        self.SUPERCHIPSTARTWINDOW = RM_Field_MODEM_S_SIFASTDETECTCTRL_SUPERCHIPSTARTWINDOW(self)
        self.zz_fdict['SUPERCHIPSTARTWINDOW'] = self.SUPERCHIPSTARTWINDOW
        self.NPULSEFIXEDTHRESHOLD = RM_Field_MODEM_S_SIFASTDETECTCTRL_NPULSEFIXEDTHRESHOLD(self)
        self.zz_fdict['NPULSEFIXEDTHRESHOLD'] = self.NPULSEFIXEDTHRESHOLD
        self.NPULSETHRESHADJEN = RM_Field_MODEM_S_SIFASTDETECTCTRL_NPULSETHRESHADJEN(self)
        self.zz_fdict['NPULSETHRESHADJEN'] = self.NPULSETHRESHADJEN
        self.NPULSETHRESHADJ = RM_Field_MODEM_S_SIFASTDETECTCTRL_NPULSETHRESHADJ(self)
