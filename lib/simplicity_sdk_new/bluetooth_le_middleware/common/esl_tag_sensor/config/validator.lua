...
if config_temp_range_enabled ~= nil and config_temp_range_enabled.number > 0 then
  local error_message = ""
  ...
  elseif config_temp_range_minval.number > config_temp_range_maxval.number then
...
if config_manufacturing_date_enabled ~= nil and config_manufacturing_date_enabled.number > 0 then
  ...
  if config_wallclock_enabled == nil or config_wallclock_enabled.number < 1 then
    dependency_error = 1
  ...
  elseif config_manufacturing_date_year == nil or config_manufacturing_date_month == nil or config_manufacturing_date_day == nil then
    ...
    local year = config_manufacturing_date_year.number
    local month = config_manufacturing_date_month.number
    local day = config_manufacturing_date_day.number
    local ones = day % 10
