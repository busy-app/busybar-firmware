#ifndef SL_HAL_GPIO_INIT_INSTANCE_CONFIG_H
#define SL_HAL_GPIO_INIT_INSTANCE_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_HAL_GPIO_INIT_INSTANCE_MODE> Pin mode
...
#define SL_HAL_GPIO_INIT_INSTANCE_MODE        SL_GPIO_MODE_PUSH_PULL

// <o SL_HAL_GPIO_INIT_INSTANCE_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_HAL_GPIO_INIT_INSTANCE_DOUT        0
...
// <gpio> SL_HAL_GPIO_INIT_INSTANCE
// $[GPIO_SL_HAL_GPIO_INIT_INSTANCE]
#warning "INSTANCE GPIO pin to initialize not configured"
// #define SL_HAL_GPIO_INIT_INSTANCE_PORT            SL_GPIO_PORT_A
// #define SL_HAL_GPIO_INIT_INSTANCE_PIN             0
// [GPIO_SL_HAL_GPIO_INIT_INSTANCE]$

// <<< sl:end pin_tool >>>

#endif // SL_HAL_GPIO_INIT_INSTANCE_CONFIG_H
