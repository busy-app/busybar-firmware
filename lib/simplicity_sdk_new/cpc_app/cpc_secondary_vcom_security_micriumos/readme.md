...
This application demonstrates how to open CPC user endpoints, and perform read and write operations.
...
The application on the secondary will open two user endpoints, SL_CPC_ENDPOINT_USER_ID_0 and SL_CPC_ENDPOINT_USER_ID_1.
