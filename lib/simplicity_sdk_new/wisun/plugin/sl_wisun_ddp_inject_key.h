/***************************************************************************//**
 * @file sl_wisun_ddp_inject_key.h
...
#ifndef SL_WISUN_DDP_INJECT_KEY_H
#define SL_WISUN_DDP_INJECT_KEY_H
...
typedef struct {
  /// PSA Key ID
  uint32_t key_id;
  /// Length of the injected key in bytes
  uint32_t key_len;
  /// Injected key
  uint8_t key[];
} SL_ATTRIBUTE_PACKED sl_wisun_ddp_inject_key_req_t;
SL_PACK_END()
...
#endif  // SL_WISUN_DDP_INJECT_KEY_H
