/***************************************************************************//**
 * @file sl_wisun_ddp_generate_key_pair.h
...
#ifndef SL_WISUN_DDP_GENERATE_KEY_PAIR_H
#define SL_WISUN_DDP_GENERATE_KEY_PAIR_H
...
typedef struct {
  /// PSA Key ID
  uint32_t key_id;
} SL_ATTRIBUTE_PACKED sl_wisun_ddp_generate_key_pair_req_t;
SL_PACK_END()

/// Output structure of DDP command for generating a Wi-SUN device key pair
typedef sl_ddp_generate_key_rsp_t sl_wisun_ddp_generate_key_pair_rsp_t;
...
#endif  // SL_WISUN_DDP_GENERATE_KEY_PAIR_H
