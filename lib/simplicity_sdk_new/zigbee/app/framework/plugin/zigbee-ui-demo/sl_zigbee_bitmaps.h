...
#define SILICONLABS_X_POSITION          ((sl_glibContext.pDisplayGeometry->xSize - SILICONLABS_BITMAP_WIDTH) / 2)
#define SILICONLABS_Y_POSITION          0
#define LIGHT_X_POSITION                ((sl_glibContext.pDisplayGeometry->xSize - LIGHT_BITMAP_WIDTH) / 2)
#define LIGHT_Y_POSITION                (sl_glibContext.pDisplayGeometry->ySize - LIGHT_BITMAP_HEIGHT - 5)
#define ZIGBEE_X_POSITION               ((sl_glibContext.pDisplayGeometry->xSize - SILICONLABS_BITMAP_WIDTH) / 2) + 2
#define ZIGBEE_Y_POSITION               SILICONLABS_BITMAP_HEIGHT + 2
