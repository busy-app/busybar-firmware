...
--]]
local zigbee_pro_stack_selected = slc.is_provided("zigbee_pro_stack")
local zigbee_pro_router_stack_selected = slc.is_provided("zigbee_pro_router_stack")
local zigbee_pro_leaf_stack_selected = slc.is_provided("zigbee_pro_leaf_stack")
