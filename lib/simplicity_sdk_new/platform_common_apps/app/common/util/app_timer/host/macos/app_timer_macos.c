/***************************************************************************//**
 * @file
 * @brief App timer implementation for macOS
 *******************************************************************************
 * # License
 ...
 ******************************************************************************/
 static sl_status_t remove_app_timer(app_timer_t *timer);
  ...
  while (NULL != tmp_timer_ptr) {
    ...
    if (true == tmp_timer_ptr->app_timer_handle.triggered) {
      ...
      if (false == tmp_timer_ptr->periodic) {
        (void)remove_app_timer(tmp_timer_ptr);
      }
