# Release Notes - XG25 SE Firmware
...
- Added explicit validation of input and output length for commands that are sent without any input/output
buffers from the mailbox interface. This causes a change in behavior of the SE Manager
...
- Secure Vault High features (first release for EFR32xG25 products)
