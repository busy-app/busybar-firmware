#ifndef SL_HAL_GPIO_INIT_EXP_7_CONFIG_H
#define SL_HAL_GPIO_INIT_EXP_7_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_HAL_GPIO_INIT_EXP_7_MODE> Pin mode
...
#define SL_HAL_GPIO_INIT_EXP_7_MODE        SL_GPIO_MODE_PUSH_PULL

// <o SL_HAL_GPIO_INIT_EXP_7_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_HAL_GPIO_INIT_EXP_7_DOUT        0
...
#define SL_HAL_GPIO_INIT_EXP_7_PORT              SL_GPIO_PORT_B
#define SL_HAL_GPIO_INIT_EXP_7_PIN               0

// [GPIO_SL_HAL_GPIO_INIT_EXP_7]$

// <<< sl:end pin_tool >>>

#endif // SL_HAL_GPIO_INIT_EXP_7_CONFIG_H
