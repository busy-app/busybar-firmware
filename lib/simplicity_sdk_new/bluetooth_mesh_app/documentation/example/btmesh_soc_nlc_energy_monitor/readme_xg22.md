...
1. Build and flash the **Bluetooth Mesh - NLC Energy Monitor Sensor** example to your device.
...
7. Add a **Bluetooth Mesh - Sensor Client** application to the network as well, which will display or log the emulated power consumption data.

8. Make sure that you select the correct sensor type with BTN0 on the Sensor client side. Don't forget, that you also need to register by long pressing BTN0, or pressing BTN1.
