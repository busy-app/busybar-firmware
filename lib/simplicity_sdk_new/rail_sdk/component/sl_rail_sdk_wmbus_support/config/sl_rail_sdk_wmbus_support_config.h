...
#ifndef SL_RAIL_SDK_WMBUS_SUPPORT_CONFIG_H
#define SL_RAIL_SDK_WMBUS_SUPPORT_CONFIG_H

#include "sl_rail_sdk_wmbus_support.h"

/**************************************************************************//**
 * @defgroup rail_sdk_wmbus_support_defines Configurations
...
// <o SL_RAIL_SDK_WMBUS_TYPE> Default Wireless M-Bus mode
// <WMBUS_MODE_S=> S mode
...
#define SL_RAIL_SDK_WMBUS_TYPE  WMBUS_MODE_T_METER ///< Default Wireless M-Bus mode
// </h>

// <h> Available Wireless M-Bus mode options for Wireless M-Bus Meter app
// <o SL_RAIL_SDK_WMBUS_ACCESSIBILITY> Default Wireless M-Bus Accessibility
...
#define SL_RAIL_SDK_WMBUS_ACCESSIBILITY  WMBUS_ACCESSIBILITY_LIMITED_ACCESS ///<  Default Wireless M-Bus Accessibility
// </h>

/** @}*/

#endif // SL_RAIL_SDK_WMBUS_SUPPORT_CONFIG_H
