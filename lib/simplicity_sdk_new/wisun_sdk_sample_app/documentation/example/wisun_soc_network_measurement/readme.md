...
For additional information and guidelines, refer to [Using the Wi-SUN Network Measurement Application](https://docs.silabs.com/wisun/latest/wisun-network-performance-measurement-app).
