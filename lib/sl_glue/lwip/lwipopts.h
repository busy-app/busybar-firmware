...
#define DEFAULT_ACCEPTMBOX_SIZE 2 //проверить значение
...
#define LWIP_DBG_TYPES_ON                                                                                                          \
    (LWIP_DBG_OFF | LWIP_DBG_TRACE) /* (LWIP_DBG_OFF|LWIP_DBG_TRACE|LWIP_DBG_STATE|LWIP_DBG_FRESH|LWIP_DBG_HALT) */
