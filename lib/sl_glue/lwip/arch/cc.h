...
//extern void lwip_debug_log(const char * fmt, ...);
#define LWIP_PLATFORM_DIAG(x)   \
    do {                        \
        printf("\033[0;31mLWIP_Debug:\033[0m "); \
        printf x;               \
    } while(0)
...
extern uint8_t
    __attribute__((section(".bss.lwip_IP6_REASSDATA"))) memp_memory_IP6_REASSDATA_base[];
...
extern uint8_t
    __attribute__((section(".bss.lwip_TCP_PCB_LISTEN"))) memp_memory_TCP_PCB_LISTEN_base[];
