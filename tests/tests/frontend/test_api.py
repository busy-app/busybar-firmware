...
class TestSystemAPI:
    ...
    def test_api_version_get(self, api_session, web_base_url, persistent_cli_connection):
        ...
        with allure.step("Verify response status and structure"):
            ...
            allure.attach(json.dumps(version_data, indent=2), "Version Response", allure.attachment_type.JSON)

            # Validate required fields
            assert "api_semver" in version_data, "Response should contain 'api_semver' field"
        ...
        with allure.step("Verify api_semver format and value"):
            ...
            assert len(version_parts) == 3, f"api_semver should be in x.y.z format, got {api_semver}"
    ...
    def test_api_status_get(self, api_session, web_base_url, persistent_cli_connection):
        ...
        with allure.step("Get CLI device_info for comparison"):
            cli_device_info = persistent_cli_connection.execute_command("device_info", timeout=20.0, slow_command=True)
            allure.attach(cli_device_info, "CLI device_info", allure.attachment_type.TEXT)
        ...
        with allure.step("Verify response status and structure"):
            ...
            allure.attach(json.dumps(status_data, indent=2), "Status Response", allure.attachment_type.JSON)
        ...
        with allure.step("Verify system data structure"):
            ...
            required_system_fields = ["branch", "version", "build_date", "commit_hash", "uptime"]
            for field in required_system_fields:
                assert field in system_data, f"System data should contain '{field}' field"

        with allure.step("Verify power data structure"):
            power_data = status_data["power"]
            required_power_fields = ["state", "battery_charge", "battery_voltage", "battery_current", "usb_voltage"]
    ...
    @pytest.mark.api
    @pytest.mark.frontend
    def test_api_status_system_get(self, api_session, web_base_url, persistent_cli_connection):
        ...
        with allure.step("Verify response status and structure"):
            ...
            allure.attach(json.dumps(system_data, indent=2), "System Status Response", allure.attachment_type.JSON)

            # Validate required fields based on OpenAPI schema
            required_fields = ["branch", "version", "build_date", "commit_hash", "uptime"]
            for field in required_fields:
                assert field in system_data, f"Response should contain '{field}' field"
                assert isinstance(system_data[field], str), f"Field '{field}' should be a string"

    @allure.id("2641")
    @allure.title("GET /api/status/power [Draft]")
    @pytest.mark.api
    @pytest.mark.frontend
    def test_api_status_power_get(self, api_session, web_base_url, persistent_cli_connection):
        ...
        with allure.step("Verify response status and structure"):
            ...
            allure.attach(json.dumps(power_data, indent=2), "Power Status Response", allure.attachment_type.JSON)

            # Validate required fields based on OpenAPI schema
            required_fields = ["state", "battery_charge", "battery_voltage", "battery_current", "usb_voltage"]
            for field in required_fields:
        ...
        with allure.step("Verify power field types and values"):
            ...
            assert power_data["state"] in valid_states, f"State should be one of {valid_states}"

            # Validate numeric fields
            numeric_fields = ["battery_charge", "battery_voltage", "battery_current", "usb_voltage"]
            for field in numeric_fields:
                assert isinstance(power_data[field], int), f"Field '{field}' should be an integer"

            # Validate battery charge percentage
            assert 0 <= power_data["battery_charge"] <= 100, "Battery charge should be between 0-100%"
...
class TestSettingsAPI:
    ...
    def test_api_access_get(self, api_session, web_base_url):
        ...
        with allure.step("Verify response status and structure"):
            ...
            allure.attach(json.dumps(access_data, indent=2), "Access Info Response", allure.attachment_type.JSON)

            # Validate required fields based on OpenAPI schema
            assert "mode" in access_data, "Response should contain 'mode' field"
            assert "key_valid" in access_data, "Response should contain 'key_valid' field"

            # Validate mode enum
            valid_modes = ["disabled", "enabled", "key"]
            assert access_data["mode"] in valid_modes, f"Mode should be one of {valid_modes}"
            assert isinstance(access_data["key_valid"], bool), "key_valid should be a boolean"
    ...
    def test_api_access_post(self, api_session, web_base_url):
        ...
        with allure.step("Make POST request to /api/access with valid parameters"):
            ...
            response = api_session.post(f"{web_base_url}/api/access", params=params, timeout=10)
        ...
        with allure.step("Verify response status and structure"):
            ...
            if response.status_code == 200:
                ...
                allure.attach(json.dumps(response_data, indent=2), "Access Set Response", allure.attachment_type.JSON)
                assert "result" in response_data, "Success response should contain 'result' field"
            else:
                error_data = response.json()
                allure.attach(json.dumps(error_data, indent=2), "Access Error Response", allure.attachment_type.JSON)
    ...
    def test_api_display_brightness_get(self, api_session, web_base_url):
        ...
        with allure.step("Make GET request to /api/display/brightness"):
            response = api_session.get(f"{web_base_url}/api/display/brightness", timeout=10)
        ...
        with allure.step("Verify response status and structure"):
            ...
            allure.attach(json.dumps(brightness_data, indent=2), "Brightness Response", allure.attachment_type.JSON)
    ...
    def test_api_display_brightness_post(self, api_session, web_base_url):
        ...
        with allure.step("Make POST request to /api/display/brightness"):
            ...
            response = api_session.post(f"{web_base_url}/api/display/brightness", params=params, timeout=10)
    ...
    def test_api_audio_volume_get(self, api_session, web_base_url):
        ...
        with allure.step("Verify response status and structure"):
            ...
            allure.attach(json.dumps(volume_data, indent=2), "Volume Response", allure.attachment_type.JSON)

            # Validate fields based on OpenAPI schema
            assert "volume" in volume_data, "Response should contain 'volume' field"
            assert isinstance(volume_data["volume"], (int, float)), "Volume should be numeric"
    ...
    def test_api_audio_volume_post(self, api_session, web_base_url):
        ...
        with allure.step("Make POST request to /api/audio/volume"):
            params = {"volume": 50}
            response = api_session.post(f"{web_base_url}/api/audio/volume", params=params, timeout=10)
...
class TestStorageAPI:
    ...
    def test_api_storage_list(self, api_session, web_base_url):
        ...
        with allure.step("Make GET request to /api/storage/list"):
            params = {"path": "/ext"}
            response = api_session.get(f"{web_base_url}/api/storage/list", params=params, timeout=10)
        ...
        with allure.step("Verify response status and structure"):
            ...
            if response.status_code == 200:
                ...
                allure.attach(json.dumps(list_data, indent=2), "Storage List Response", allure.attachment_type.JSON)

                # Validate structure based on OpenAPI schema
                assert "list" in list_data, "Response should contain 'list' field"
                assert isinstance(list_data["list"], list), "List field should be an array"
                ...
                for item in list_data["list"]:
                    ...
                    assert item["type"] in ["file", "dir"], "Type should be 'file' or 'dir'"

                    if item["type"] == "file":
                        assert "size" in item, "File items should contain 'size' field"
                        assert isinstance(item["size"], int), "File size should be an integer"
    ...
    def test_api_storage_mkdir(self, api_session, web_base_url):
        ...
        with allure.step(f"Create test directory: {test_dir}"):
            ...
            response = api_session.post(f"{web_base_url}/api/storage/mkdir", params=params, timeout=10)
        ...
        with allure.step("Verify directory creation response"):
            ...
            if response.status_code == 200:
                response_data = response.json()
                allure.attach(json.dumps(response_data, indent=2), "Mkdir Response", allure.attachment_type.JSON)
                assert "result" in response_data, "Success response should contain 'result' field"

    @allure.id("2650")
    @allure.title("POST /api/storage/write + GET /api/storage/read + DELETE /api/storage/remove [Draft]")
    @pytest.mark.api
    @pytest.mark.frontend
    def test_api_storage_write_read_remove(self, api_session, web_base_url):
        ...
        with allure.step(f"Write test file: {test_file}"):
            ...
            if response.status_code == 200:
                ...
                allure.attach(json.dumps(write_response, indent=2), "Write Response", allure.attachment_type.JSON)

                with allure.step(f"Read test file: {test_file}"):
                    params = {"path": test_file}
                    read_response = api_session.get(f"{web_base_url}/api/storage/read", params=params, timeout=10)

                    if read_response.status_code == 200:
                        assert read_response.content == test_content, "Read content should match written content"
                        allure.attach(read_response.content.decode(), "File Content", allure.attachment_type.TEXT)

                        with allure.step(f"Remove test file: {test_file}"):
                            params = {"path": test_file}
                            remove_response = api_session.delete(f"{web_base_url}/api/storage/remove", params=params,
                                                                 timeout=10)

                            if remove_response.status_code == 200:
                                remove_data = remove_response.json()
                                allure.attach(json.dumps(remove_data, indent=2), "Remove Response",
...
class TestAssetsAPI:
    ...
    def test_api_assets_upload(self, api_session, web_base_url):
        ...
        with allure.step("Verify upload response"):
            ...
            if response.status_code == 200:
                response_data = response.json()
                allure.attach(json.dumps(response_data, indent=2), "Asset Upload Response", allure.attachment_type.JSON)
    ...
    def test_api_assets_delete(self, api_session, web_base_url):
        ...
        with allure.step(f"Delete assets for app {test_app_id}"):
            ...
            response = api_session.delete(f"{web_base_url}/api/assets/upload", params=params, timeout=10)
    ...
    def test_api_display_draw(self, api_session, web_base_url):
        ...
        with allure.step("Verify draw response"):
            if response.status_code == 423:
                assert False, "Device is busy (423 Locked). Move the selector away from busy mode"
            else:
                assert response.status_code in [200, 400], f"Expected 200, 400, got {response.status_code}"

                if response.status_code in [200, 400]:
                    response_data = response.json()
                    allure.attach(json.dumps(response_data, indent=2), "Display Draw Response", allure.attachment_type.JSON)
    ...
    def test_api_display_clear(self, api_session, web_base_url):
        ...
        with allure.step("Clear display"):
            response = api_session.delete(f"{web_base_url}/api/display/draw", timeout=10)
    ...
    def test_api_audio_play(self, api_session, web_base_url):
        ...
        with allure.step("Play audio file"):
            ...
            response = api_session.post(f"{web_base_url}/api/audio/play", params=params, timeout=10)
...
class TestWifiAPI:
    ...
    def test_api_wifi_status(self, api_session, web_base_url):
        ...
        with allure.step("Verify status response"):
            ...
            status_data = response.json()
            allure.attach(json.dumps(status_data, indent=2), "WiFi Status Response", allure.attachment_type.JSON)

            # Validate required fields
            assert "state" in status_data, "Response should contain 'state' field"
            valid_states = ["disabled", "enabled", "connected"]
            assert status_data["state"] in valid_states, f"State should be one of {valid_states}"
    ...
    def test_api_wifi_networks(self, api_session, web_base_url):
        ...
        with allure.step("Scan for WiFi networks"):
            response = api_session.get(f"{web_base_url}/api/wifi/networks", timeout=30)  # Longer timeout for scan
        ...
        with allure.step("Verify networks response"):
            ...
            if response.status_code == 200:
                ...
                allure.attach(json.dumps(networks_data, indent=2), "WiFi Networks Response",
                              allure.attachment_type.JSON)

                assert "count" in networks_data, "Response should contain 'count' field"
                assert "networks" in networks_data, "Response should contain 'networks' field"
                assert isinstance(networks_data["networks"], list), "Networks should be a list"
    ...
    def test_api_wifi_connect_invalid(self, api_session, web_base_url):
        ...
        with allure.step("Attempt WiFi connection with invalid credentials"):
            ...
            response = api_session.post(
                f"{web_base_url}/api/wifi/connect",
                json=connect_data,
                timeout=30
            )
    ...
    def test_api_wifi_disconnect(self, api_session, web_base_url):
        ...
        with allure.step("Disconnect from WiFi"):
            response = api_session.post(f"{web_base_url}/api/wifi/disconnect", timeout=10)
...
class TestBleAPI:
    ...
    def test_api_ble_enable(self, api_session, web_base_url):
        ...
        with allure.step("Verify enable response"):
            ...
            response_data = response.json()
            allure.attach(json.dumps(response_data, indent=2), "BLE Enable Response", allure.attachment_type.JSON)
    ...
    def test_api_ble_disable(self, api_session, web_base_url):
        ...
        with allure.step("Verify disable response"):
            ...
            response_data = response.json()
            allure.attach(json.dumps(response_data, indent=2), "BLE Disable Response", allure.attachment_type.JSON)
...
class TestInputAPI:
    ...
    def test_api_input_key_post(self, api_session, web_base_url):
        ...
        valid_keys = ["up", "down", "ok", "back", "start", "busy", "status", "off", "apps", "settings"]

        for key in valid_keys:
            with allure.step(f"Send key event: {key}"):
                params = {"key": key}
                response = api_session.post(f"{web_base_url}/api/input", params=params, timeout=10)

                assert response.status_code in [200,
                                                400], f"Expected 200 or 400 for key {key}, got {response.status_code}"

                if response.status_code == 200:
                    response_data = response.json()
                    allure.attach(json.dumps(response_data, indent=2), f"Input {key} Response",
                                  allure.attachment_type.JSON)
    ...
    def test_api_input_invalid_key(self, api_session, web_base_url):
        ...
        with allure.step("Verify invalid key response"):
            ...
            error_data = response.json()
            allure.attach(json.dumps(error_data, indent=2), "Invalid Key Error Response", allure.attachment_type.JSON)
            assert "error" in error_data, "Error response should contain 'error' field"
...
class TestStreamingAPI:
    ...
    def test_api_screen_front_display(self, api_session, web_base_url):
        ...
        with allure.step("Get front display frame"):
            ...
            response = api_session.get(f"{web_base_url}/api/screen", params=params, timeout=10)
        ...
        with allure.step("Verify screen response"):
            ...
            if response.status_code == 200:
                ...
                allure.attach(response.content, "Front Display Frame", allure.attachment_type.PNG)
    ...
    def test_api_screen_back_display(self, api_session, web_base_url):
        ...
        with allure.step("Verify screen response"):
            ...
            if response.status_code == 200:
                ...
                assert "image/bmp" in content_type.lower(), f"Expected BMP image, got {content_type}"
                assert len(response.content) > 0, "Image data should not be empty"
                allure.attach(response.content, "Back Display Frame", allure.attachment_type.PNG)
    ...
    def test_api_screen_invalid_display(self, api_session, web_base_url):
        ...
        with allure.step("Verify error response"):
            assert response.status_code == 400, f"Expected 400 for invalid display, got {response.status_code}"
...
class TestUpdateAPI:
    ...
    @pytest.mark.api
    @pytest.mark.frontend
    def test_api_update_post(self, api_session, web_base_url, persistent_cli_connection):
        ...
        with allure.step("Get initial device info for version comparison"):
            initial_device_info = persistent_cli_connection.execute_command("device_info", timeout=20.0,
                                                                            slow_command=True)
            allure.attach(initial_device_info, "Initial Device Info", allure.attachment_type.TEXT)
        ...
        with allure.step("Verify update response"):
            ...
            response_data = response.json()
            allure.attach(json.dumps(response_data, indent=2), "Update Response", allure.attachment_type.JSON)
...
class TestAPIErrorHandling:
        ...
        for endpoint, params in test_cases:
            with allure.step(f"Test missing parameters for {endpoint}"):
                if endpoint == "/api/input":
                    response = api_session.post(f"{web_base_url}{endpoint}", params=params, timeout=10)
                else:
                    response = api_session.get(f"{web_base_url}{endpoint}", params=params, timeout=10)

                assert response.status_code == 400, f"Expected 400 for missing params on {endpoint}, got {response.status_code}"
    ...
    def test_api_invalid_parameter_values(self, api_session, web_base_url):
        ...
        for endpoint, params in test_cases:
            with allure.step(f"Test invalid parameters for {endpoint}"):
                ...
                assert response.status_code == 400, f"Expected 400 for invalid params on {endpoint}, got {response.status_code}"
    ...
    def test_api_file_upload_size_limit(self, api_session, web_base_url):
        ...
        with allure.step(f"Check if test file already exists: {test_file_path}"):
            ...
            check_response = api_session.get(f"{web_base_url}/api/storage/read", params={"path": test_file_path},
                                             timeout=10)
            if check_response.status_code == 200:
                allure.attach(f"File {test_file_path} already exists, attempting cleanup", "Pre-cleanup",
                              allure.attachment_type.TEXT)

                # File exists, try to delete it first
                delete_response = api_session.delete(f"{web_base_url}/api/storage/remove",
                                                     params={"path": test_file_path}, timeout=10)
                if delete_response.status_code != 200:
                    pytest.fail(
                        f"Failed to delete existing test file {test_file_path}. Status: {delete_response.status_code}")
                else:
                    allure.attach(f"Successfully cleaned up existing file {test_file_path}", "Pre-cleanup Success",
                                  allure.attachment_type.TEXT)
        ...
        try:
            ...
            with allure.step("Verify size limit handling"):
                ...
                assert response.status_code in [200, 400, 413,
                                                500], f"Expected 200, 400, 413, or 500, got {response.status_code}"

                if response.status_code == 200:
                    upload_successful = True
                    allure.attach("Large file upload succeeded - no size limit enforced", "Upload Result",
                                  allure.attachment_type.TEXT)

                    # Verify file was actually written by checking its size
                    verify_response = api_session.get(f"{web_base_url}/api/storage/read",
                                                      params={"path": test_file_path}, timeout=10)
                    if verify_response.status_code == 200:
                        ...
                        allure.attach(
                            ...
                            "Size Verification", allure.attachment_type.TEXT)
                    ...
                    allure.attach(
                        ...
                        "Upload Result", allure.attachment_type.TEXT)

        finally:
            # Always attempt cleanup if upload was successful
            if upload_successful:
                with allure.step(f"Clean up test file: {test_file_path}"):
                    cleanup_response = api_session.delete(f"{web_base_url}/api/storage/remove",
                                                          params={"path": test_file_path}, timeout=10)

                    if cleanup_response.status_code == 200:
                        allure.attach("Large test file cleaned up successfully", "Cleanup Success",
                                      allure.attachment_type.TEXT)
                    else:
                        ...
                        allure.attach(error_msg, "Cleanup Failure", allure.attachment_type.TEXT)
    ...
    def test_api_concurrent_requests(self, api_session, web_base_url):
        ...
        with allure.step("Verify all requests succeeded"):
            ...
            assert success_count >= 3, f"Expected at least 3 successful requests, got {success_count} out of {len(response_codes)}"
...
class TestAPIAuthentication:
    ...
    def test_api_without_auth_token(self, api_session, web_base_url):
        ...
        with allure.step("Access protected endpoint without auth"):
            response = api_session.get(f"{web_base_url}/api/status", headers=headers, timeout=10)
    ...
    def test_api_with_valid_auth_token(self, api_auth_session, web_base_url):
        ...
        with allure.step("Verify successful access"):
            assert response.status_code == 200, f"Expected 200 with valid auth, got {response.status_code}"
