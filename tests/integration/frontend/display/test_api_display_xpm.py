    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                "front",
                f"elements[0].data value is invalid; must be no larger than the display ({FRONT_DISPLAY_WIDTH}x{FRONT_DISPLAY_HEIGHT})",
                id="front-width",
            ),
            pytest.param(
                "back width 161",
                ...
                "back",
                f"elements[0].data value is invalid; must be no larger than the display ({BACK_DISPLAY_WIDTH}x{BACK_DISPLAY_HEIGHT})",
                id="back-width",
            ),
            pytest.param(
                "front height 17",
