...
`,Oe=typeof self<"u"&&self.Blob&&new Blob(["URL.revokeObjectURL(import.meta.url);",He],{type:"text/javascript;charset=utf-8"});function Gr(t){let e;try{if(e=Oe&&(self.URL||self.webkitURL).createObjectURL(Oe),!e)throw"";const r=new Worker(e,{type:"module",name:t?.name});return r.addEventListener("error",()=>{(self.URL||self.webkitURL).revokeObjectURL(e)}),r}catch{return new Worker("data:text/javascript;charset=utf-8,"+encodeURIComponent(He),{type:"module",name:t?.name})}}const $r=`var commonjsGlobal = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, src = { exports: {} }, indexLight = { exports: {} }, indexMinimal = {}, minimal = {}, aspromise, hasRequiredAspromise;
function requireAspromise() {
  if (hasRequiredAspromise) return aspromise;
  hasRequiredAspromise = 1, aspromise = a;
  function a(f, h) {
...
*/const oe={newline:10,reset:27};function Qr(t){if(!Number.isSafeInteger(t))throw new Error(`integer expected: ${t}`)}function ei(t){if(!Number.isSafeInteger(t)||t<1||t>40)throw new Error(`Invalid version=${t}. Expected number [1..40]`)}function X(t,e){return t.toString(2).padStart(e,"0")}function qe(t,e){const r=t%e;return r>=0?r:e+r}function G(t,e){return new Array(t).fill(e)}function ge(t){return t=t-(t>>>1&1431655765),t=(t&858993459)+(t>>>2&858993459),(t+(t>>>4)&252645135)*16843009>>>24}function Pe(t){let e=0,r=0;for(const o of t)e=Math.max(e,o.length),r+=o.length;const i=new Uint8Array(r);let n=0;for(let o=0;o<e;o++)for(const s of t)o<s.length&&(i[n++]=s[o]);return i}function ti(){let t,e=1/0;return{add(r,i){r>=e||(t=i,e=r)},get:()=>t,score:()=>e}}function De(t){return{has:e=>t.includes(e),decode:e=>{if(!Array.isArray(e)||e.length&&typeof e[0]!="string")throw new Error("alphabet.decode input should be array of strings");return e.map(r=>{if(typeof r!="string")throw new Error(`alphabet.decode: not string element=${r}`);const i=t.indexOf(r);if(i===-1)throw new Error(`Unknown letter: "${r}". Allowed: ${t}`);return i})},encode:e=>{if(!Array.isArray(e)||e.length&&typeof e[0]!="number")throw new Error("alphabet.encode input should be an array of numbers");return e.map(r=>{if(Qr(r),r<0||r>=t.length)throw new Error(`Digit index outside alphabet: ${r} (alphabet: ${t.length})`);return t[r]})}}}function xe(t){if(t.length!==32)throw new Error("expects 32 element matrix");const e=[1431655765,858993459,252645135,16711935,65535];for(let r=0;r<5;r++){const i=e[r]>>>0,n=1<<r,o=n<<1;for(let s=0;s<32;s+=o)for(let a=0;a<n;a++){const u=s+a,c=u+n,d=t[u]>>>0,l=t[c]>>>0,f=(d>>>n^l)&i;t[u]=(d^f<<n)>>>0,t[c]=(l^f)>>>0}}}const se=t=>1<<(t&31)>>>0,Z=(t,e)=>e===0?0:e===32?4294967295:(1<<e)-1<<t>>>0;class D{static size(e,r){if(typeof e=="number"&&(e={height:e,width:e}),!Number.isSafeInteger(e.height)&&e.height!==1/0)throw new Error(`Bitmap: invalid height=${e.height} (${typeof e.height})`);if(!Number.isSafeInteger(e.width)&&e.width!==1/0)throw new Error(`Bitmap: invalid width=${e.width} (${typeof e.width})`);return r!==void 0&&(e={width:Math.min(e.width,r.width),height:Math.min(e.height,r.height)}),e}static fromString(e){e=e.replace(/^\n+/g,"").replace(/\n+$/g,"");const r=e.split(String.fromCharCode(oe.newline)),i=r.length;let n;const o=[];for(const s of r){const a=s.split("").map(u=>{if(u==="X")return!0;if(u===" ")return!1;if(u!=="?")throw new Error(`Bitmap.fromString: unknown symbol=${u}`)});if(n!==void 0&&a.length!==n)throw new Error(`Bitmap.fromString different row sizes: width=${n} cur=${a.length}`);n=a.length,o.push(a)}return n===void 0&&(n=0),new D({height:i,width:n},o)}defined;value;tailMask;words;fullWords;height;width;constructor(e,r){const{height:i,width:n}=D.size(e);if(this.height=i,this.width=n,this.tailMask=Z(0,n&31||32),this.words=Math.ceil(n/32)|0,this.fullWords=Math.floor(n/32)|0,this.value=new Uint32Array(this.words*i),this.defined=new Uint32Array(this.value.length),r){if(r.length!==i)throw new Error(`Bitmap: data height mismatch: exp=${i} got=${r.length}`);for(let o=0;o<i;o++){const s=r[o];if(!s||s.length!==n)throw new Error(`Bitmap: data width mismatch at y=${o}: exp=${n} got=${s?.length}`);for(let a=0;a<n;a++)this.set(a,o,s[a])}}}point(e){return this.get(e.x,e.y)}isInside(e){return 0<=e.x&&e.x<this.width&&0<=e.y&&e.y<this.height}size(e){if(!e)return{height:this.height,width:this.width};const{x:r,y:i}=this.xy(e);return{height:this.height-i,width:this.width-r}}xy(e){if(typeof e=="number"&&(e={x:e,y:e}),!Number.isSafeInteger(e.x))throw new Error(`Bitmap: invalid x=${e.x}`);if(!Number.isSafeInteger(e.y))throw new Error(`Bitmap: invalid y=${e.y}`);return e.x=qe(e.x,this.width),e.y=qe(e.y,this.height),e}wordIndex(e,r){return r*this.words+(e>>>5)}bitIndex(e,r){return{word:this.wordIndex(e,r),bit:e&31}}isDefined(e,r){const i=this.wordIndex(e,r),n=se(e);return(this.defined[i]&n)!==0}get(e,r){const i=this.wordIndex(e,r),n=se(e);return(this.value[i]&n)!==0}maskWord(e,r,i){const{defined:n,value:o}=this;n[e]|=r,o[e]=o[e]&~r|-i&r}set(e,r,i){i!==void 0&&this.maskWord(this.wordIndex(e,r),se(e),i)}fillRectConst(e,r,i,n,o){if(i<=0||n<=0||o===void 0)return;const{value:s,defined:a,words:u}=this,c=e>>>5,d=e+i-1>>>5,l=e&31,f=e+i-1&31;for(let h=0;h<n;h++){const g=(r+h)*u;if(c===d){const y=Z(l,f-l+1);this.maskWord(g+c,y,o);continue}this.maskWord(g+c,Z(l,32-l),o);for(let y=c+1;y<d;y++)a[g+y]=4294967295,s[g+y]=o?4294967295:0;this.maskWord(g+d,Z(0,f+1),o)}}rectWords(e,r,i,n,o){for(let s=0;s<n;s++){const a=r+s;for(let u=0;u<i;){const c=e+u,{bit:d,word:l}=this.bitIndex(c,a),f=Math.min(32-d,i-u);o(l,c,u,s,f),u+=f}}}rect(e,r,i){const{x:n,y:o}=this.xy(e),{height:s,width:a}=D.size(r,this.size({x:n,y:o}));if(typeof i!="function")return this.fillRectConst(n,o,a,s,i),this;const{defined:u,value:c}=this;return this.rectWords(n,o,a,s,(d,l,f,h,g)=>{let y=0,w=c[d];for(let _=0;_<g;_++){const p=se(l+_),b=i({x:f+_,y:h},(w&p)!==0);b!==void 0&&(y|=p,w=w&~p|-b&p)}u[d]|=y,c[d]=w}),this}rectRead(e,r,i){const{x:n,y:o}=this.xy(e),{height:s,width:a}=D.size(r,this.size({x:n,y:o})),{value:u}=this;return this.rectWords(n,o,a,s,(c,d,l,f,h)=>{const g=u[c];for(let y=0;y<h;y++){const w=se(d+y);i({x:l+y,y:f},(g&w)!==0)}}),this}hLine(e,r,i){return this.rect(e,{width:r,height:1},i)}vLine(e,r,i){return this.rect(e,{width:1,height:r},i)}border(e=2,r){const i=this.height+2*e,n=this.width+2*e,o=new D({height:i,width:n});return o.rect(0,1/0,r),o.embed({x:e,y:e},this),o}embed(e,r){const{x:i,y:n}=this.xy(e),{height:o,width:s}=D.size(r.size(),this.size({x:i,y:n}));if(s<=0||o<=0)return this;const{value:a,defined:u}=this,{words:c,value:d}=r;for(let l=0;l<o;l++){const f=l*c;for(let h=0;h<s;){const g=i+h,{word:y,bit:w}=this.bitIndex(g,n+l),{word:_,bit:p}=r.bitIndex(h,l),b=Math.min(32-w,s-h),I=d[_],H=p&&_+1<f+c?d[_+1]:0,$=p?(I>>>p|H<<32-p)>>>0:I,U=Z(w,b),F=($&Z(0,b))<<w>>>0;u[y]|=U,a[y]=a[y]&~U|F,h+=b}}return this}rectSlice(e,r=this.size()){const{x:i,y:n}=this.xy(e),{height:o,width:s}=D.size(r,this.size({x:i,y:n})),a=new D({height:o,width:s});return this.rectRead({x:i,y:n},{height:o,width:s},(u,c)=>{this.isDefined(i+u.x,n+u.y)&&a.set(u.x,u.y,c)}),a}transpose(){const{height:e,width:r,value:i,defined:n,words:o}=this,s=new D({height:r,width:e}),{words:a,value:u,defined:c,tailMask:d}=s,l=new Uint32Array(32),f=new Uint32Array(32);for(let h=0;h<e;h+=32)for(let g=0;g<o;g++){const y=Math.min(32,e-h);for(let w=0;w<y;w++){const _=this.wordIndex(32*g,h+w);l[w]=i[_],f[w]=n[_]}l.fill(0,y),f.fill(0,y),xe(l),xe(f);for(let w=0;w<32;w++){const _=g*32+w;if(_>=r)break;const p=s.wordIndex(h,_),b=h>>>5===a-1?d:4294967295;u[p]=l[w]&b,c[p]=f[w]&b}}return s}negate(){const e=this.defined.length;for(let r=0;r<e;r++)this.value[r]=~this.value[r],this.defined[r]=4294967295;return this}scale(e){if(!Number.isSafeInteger(e)||e>1024)throw new Error(`invalid scale factor: ${e}`);const{height:r,width:i}=this;return new D({height:e*r,width:e*i}).rect({x:0,y:0},1/0,({x:o,y:s})=>this.get(o/e|0,s/e|0))}clone(){const e=new D(this.size());return e.defined.set(this.defined),e.value.set(this.value),e}assertDrawn(){const{height:e,width:r,defined:i,tailMask:n,fullWords:o,words:s}=this;if(!(!e||!r))for(let a=0;a<e;a++){const u=a*s;for(let c=0;c<o;c++)if(i[u+c]!==4294967295)throw new Error("Invalid color type=undefined");if(s!==o&&(i[u+o]&n)!==n)throw new Error("Invalid color type=undefined")}}countPatternInRow(e,r,...i){if(r<=0||r>=32)throw new Error("wrong patternLen");const n=(1<<r)-1,{width:o,value:s,words:a}=this;let u=0;const c=this.wordIndex(0,e);for(let d=0,l=0;d<a;d++){const f=s[c+d],h=d===a-1&&o&31||32;for(let g=0;g<h;g++)if(l=(l<<1|f>>>g&1)&n,!(d*32+g+1<r)){for(const y of i)if(l===y){u++;break}}}return u}getRuns(e,r){const{width:i,value:n,words:o}=this;if(i===0)return;let s=0,a;const u=this.wordIndex(0,e);for(let c=0;c<o;c++){const d=n[u+c],l=c===o-1&&i&31||32;for(let f=0;f<l;f++){const h=(d&1<<f)!==0;if(h===a){s++;continue}a!==void 0&&r(s,a),a=h,s=1}}a!==void 0&&r(s,a)}popcnt(){const{height:e,width:r,words:i,fullWords:n,tailMask:o}=this;if(!e||!r)return 0;let s=0;for(let a=0;a<e;a++){const u=a*i;for(let c=0;c<n;c++)s+=ge(this.value[u+c]);i!==n&&(s+=ge(this.value[u+n]&o))}return s}countBoxes2x2(e){const{width:r,words:i}=this;if(r<2||(e|0)<0||e+1>=this.height)return 0;const n=this.wordIndex(0,e)|0,o=this.wordIndex(0,e+1)|0,a=(r&31)===0?2147483647:Z(0,r-1&31);let u=0;for(let c=0;c<i;c++){const d=this.value[n+c],l=this.value[o+c],f=~(d^l)>>>0,h=c+1<i?this.value[n+c+1]>>>0:0,g=~(d^(d>>>1|(h&1)<<31)>>>0)>>>0,y=c+1<i?this.value[o+c+1]>>>0:0,w=~(l^(l>>>1|(y&1)<<31)>>>0)>>>0;let _=(f&g&w)>>>0;c===i-1&&(_&=a),u+=ge(_)}return u}toString(){const e=String.fromCharCode(oe.newline);let r="";for(let i=0;i<this.height;i++){let n="";for(let o=0;o<this.width;o++){const s=this.get(o,i);n+=this.isDefined(o,i)?s?"X":" ":"?"}r+=n+(i+1===this.height?"":e)}return r}toRaw(){const e=Array.from({length:this.height},()=>new Array(this.width));for(let r=0;r<this.height;r++){const i=e[r];for(let n=0;n<this.width;n++)i[n]=this.get(n,r)}return e}toASCII(){const{height:e,width:r}=this;let i="";for(let n=0;n<e;n+=2){for(let o=0;o<r;o++){const s=this.get(o,n),a=n+1>=e?!0:this.get(o,n+1);!s&&!a?i+="█":!s&&a?i+="▀":s&&!a?i+="▄":s&&a&&(i+=" ")}i+=String.fromCharCode(oe.newline)}return i}toTerm(){const e=String.fromCharCode(oe.reset),r=e+"[0m",i=e+"[1;47m  "+r,n=e+"[40m  "+r,o=String.fromCharCode(oe.newline);let s="";for(let a=0;a<this.height;a++){for(let u=0;u<this.width;u++){const c=this.get(u,a);s+=c?n:i}s+=o}return s}toSVG(e=!0){let r=`<svg viewBox="0 0 ${this.width} ${this.height}" xmlns="http://www.w3.org/2000/svg">`,i="",n;return this.rectRead(0,1/0,(o,s)=>{if(!s)return;const{x:a,y:u}=o;if(!e){r+=`<rect x="${a}" y="${u}" width="1" height="1" />`;return}let c=`M${a} ${u}`;if(n){const l=`m${a-n.x} ${u-n.y}`;l.length<=c.length&&(c=l)}const d=a<10?`H${a}`:"h-1";i+=`${c}h1v1${d}Z`,n=o}),e&&(r+=`<path d="${i}"/>`),r+="</svg>",r}toGIF(){const e=a=>[a&255,a>>>8&255],r=[...e(this.width),...e(this.height)],i=[];this.rectRead(0,1/0,(a,u)=>i.push(+(u===!0)));const n=126,o=[71,73,70,56,55,97,...r,246,0,0,255,255,255,...G(381,0),44,0,0,0,0,...r,0,7],s=Math.floor(i.length/n);for(let a=0;a<s;a++)o.push(n+1,128,...i.slice(n*a,n*(a+1)).map(u=>+u));return o.push(i.length%n+1,128,...i.slice(s*n).map(a=>+a)),o.push(1,129,0,59),new Uint8Array(o)}toImage(e=!1){const{height:r,width:i}=this.size(),n=new Uint8Array(r*i*(e?3:4));let o=0;for(let s=0;s<r;s++)for(let a=0;a<i;a++){const u=this.get(a,s)?0:255;n[o++]=u,n[o++]=u,n[o++]=u,e||(n[o++]=255)}return{height:r,width:i,data:n}}}const Ue=["low","medium","quartile","high"],je=["numeric","alphanumeric","byte","kanji","eci"],ri=[26,44,70,100,134,172,196,242,292,346,404,466,532,581,655,733,815,901,991,1085,1156,1258,1364,1474,1588,1706,1828,1921,2051,2185,2323,2465,2611,2761,2876,3034,3196,3362,3532,3706],ii={low:[7,10,15,20,26,18,20,24,30,18,20,24,26,30,22,24,28,30,28,28,28,28,30,30,26,28,30,30,30,30,30,30,30,30,30,30,30,30,30,30],medium:[10,16,26,18,24,16,18,22,22,26,30,22,22,24,24,28,28,26,26,26,26,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28,28],quartile:[13,22,18,26,18,24,18,22,20,24,28,26,24,20,30,24,28,28,26,30,28,30,30,30,30,28,30,30,30,30,30,30,30,30,30,30,30,30,30,30],high:[17,28,22,16,22,28,26,26,24,28,24,28,22,24,24,30,28,28,26,28,30,24,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30]},ni={low:[1,1,1,1,1,2,2,2,2,4,4,4,4,4,6,6,6,6,7,8,8,9,9,10,12,12,12,13,14,15,16,17,18,19,19,20,21,22,24,25],medium:[1,1,1,2,2,4,4,4,5,5,5,8,9,9,10,10,11,13,14,16,17,17,18,20,21,23,25,26,28,29,31,33,35,37,38,40,43,45,47,49],quartile:[1,1,2,2,4,4,6,6,8,8,8,10,12,16,12,17,16,18,21,20,23,23,25,27,29,34,34,35,38,40,43,45,48,51,53,56,59,62,65,68],high:[1,1,2,4,4,4,5,6,8,8,11,11,16,16,18,16,19,21,25,25,25,34,30,32,35,37,40,42,45,48,51,54,57,60,63,66,70,74,77,81]},P={size:{encode:t=>21+4*(t-1),decode:t=>(t-17)/4},sizeType:t=>Math.floor((t+7)/17),alignmentPatterns(t){if(t===1)return[];const e=6,r=P.size.encode(t)-e-1,i=r-e,n=Math.ceil(i/28);let o=Math.floor(i/n);o%2?o+=1:i%n*2>=n&&(o+=2);const s=[e];for(let a=1;a<n;a++)s.push(r-(n-a)*o);return s.push(r),s},ECCode:{low:1,medium:0,quartile:3,high:2},formatMask:21522,formatBits(t,e){const r=P.ECCode[t]<<3|e;let i=r;for(let n=0;n<10;n++)i=i<<1^(i>>9)*1335;return(r<<10|i)^P.formatMask},versionBits(t){let e=t;for(let r=0;r<12;r++)e=e<<1^(e>>11)*7973;return t<<12|e},alphabet:{numeric:De("0123456789"),alphanumerc:De("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:")},lengthBits(t,e){return{numeric:[10,12,14],alphanumeric:[9,11,13],byte:[8,16,16],kanji:[8,10,12],eci:[0,0,0]}[e][P.sizeType(t)]},modeBits:{numeric:"0001",alphanumeric:"0010",byte:"0100",kanji:"1000",eci:"0111"},capacity(t,e){const r=ri[t-1],i=ii[e][t-1],n=ni[e][t-1],o=Math.floor(r/n)-i,s=n-r%n;return{words:i,numBlocks:n,shortBlocks:s,blockLen:o,capacity:(r-i*n)*8,total:(i+o)*n+n-s}}},_e=[(t,e)=>(t+e)%2==0,(t,e)=>e%2==0,(t,e)=>t%3==0,(t,e)=>(t+e)%3==0,(t,e)=>(Math.floor(e/2)+Math.floor(t/3))%2==0,(t,e)=>t*e%2+t*e%3==0,(t,e)=>(t*e%2+t*e%3)%2==0,(t,e)=>((t+e)%2+t*e%3)%2==0],v={tables:(t=>{const e=G(256,0),r=G(256,0);for(let i=0,n=1;i<256;i++)e[i]=n,r[n]=i,n<<=1,n&256&&(n^=t);return{exp:e,log:r}})(285),exp:t=>v.tables.exp[t],log(t){if(t===0)throw new Error(`GF.log: invalid arg=${t}`);return v.tables.log[t]%255},mul(t,e){return t===0||e===0?0:v.tables.exp[(v.tables.log[t]+v.tables.log[e])%255]},add:(t,e)=>t^e,pow:(t,e)=>v.tables.exp[v.tables.log[t]*e%255],inv(t){if(t===0)throw new Error(`GF.inverse: invalid arg=${t}`);return v.tables.exp[255-v.tables.log[t]]},polynomial(t){if(t.length==0)throw new Error("GF.polymomial: invalid length");if(t[0]!==0)return t;let e=0;for(;e<t.length-1&&t[e]==0;e++);return t.slice(e)},monomial(t,e){if(t<0)throw new Error(`GF.monomial: invalid degree=${t}`);if(e==0)return[0];let r=G(t+1,0);return r[0]=e,v.polynomial(r)},degree:t=>t.length-1,coefficient:(t,e)=>t[v.degree(t)-e],mulPoly(t,e){if(t[0]===0||e[0]===0)return[0];const r=G(t.length+e.length-1,0);for(let i=0;i<t.length;i++)for(let n=0;n<e.length;n++)r[i+n]=v.add(r[i+n],v.mul(t[i],e[n]));return v.polynomial(r)},mulPolyScalar(t,e){if(e==0)return[0];if(e==1)return t;const r=G(t.length,0);for(let i=0;i<t.length;i++)r[i]=v.mul(t[i],e);return v.polynomial(r)},mulPolyMonomial(t,e,r){if(e<0)throw new Error("GF.mulPolyMonomial: invalid degree");if(r==0)return[0];const i=G(t.length+e,0);for(let n=0;n<t.length;n++)i[n]=v.mul(t[n],r);return v.polynomial(i)},addPoly(t,e){if(t[0]===0)return e;if(e[0]===0)return t;let r=t,i=e;r.length>i.length&&([r,i]=[i,r]);let n=G(i.length,0),o=i.length-r.length,s=i.slice(0,o);for(let a=0;a<s.length;a++)n[a]=s[a];for(let a=o;a<i.length;a++)n[a]=v.add(r[a-o],i[a]);return v.polynomial(n)},remainderPoly(t,e){const r=Array.from(t);for(let i=0;i<t.length-e.length+1;i++){const n=r[i];if(n!==0)for(let o=1;o<e.length;o++)e[o]!==0&&(r[i+o]=v.add(r[i+o],v.mul(e[o],n)))}return r.slice(t.length-e.length+1,r.length)},divisorPoly(t){let e=[1];for(let r=0;r<t;r++)e=v.mulPoly(e,[1,v.pow(2,r)]);return e},evalPoly(t,e){if(e==0)return v.coefficient(t,0);let r=t[0];for(let i=1;i<t.length;i++)r=v.add(v.mul(e,r),t[i]);return r},euclidian(t,e,r){v.degree(t)<v.degree(e)&&([t,e]=[e,t]);let i=t,n=e,o=[0],s=[1];for(;2*v.degree(n)>=r;){let c=i,d=o;if(i=n,o=s,i[0]===0)throw new Error("rLast[0] === 0");n=c;let l=[0];const f=v.inv(i[0]);for(;v.degree(n)>=v.degree(i)&&n[0]!==0;){const h=v.degree(n)-v.degree(i),g=v.mul(n[0],f);l=v.addPoly(l,v.monomial(h,g)),n=v.addPoly(n,v.mulPolyMonomial(i,h,g))}if(l=v.mulPoly(l,o),s=v.addPoly(l,d),v.degree(n)>=v.degree(i))throw new Error(`Division failed r: ${n}, rLast: ${i}`)}const a=v.coefficient(s,0);if(a==0)throw new Error("sigmaTilde(0) was zero");const u=v.inv(a);return[v.mulPolyScalar(s,u),v.mulPolyScalar(n,u)]}};function oi(t){return{encode(e){const r=v.divisorPoly(t),i=Array.from(e);return i.push(...r.slice(0,-1).fill(0)),Uint8Array.from(v.remainderPoly(i,r))},decode(e){const r=e.slice(),i=v.polynomial(Array.from(e));let n=G(t,0),o=!1;for(let l=0;l<t;l++){const f=v.evalPoly(i,v.exp(l));n[n.length-1-l]=f,f!==0&&(o=!0)}if(!o)return r;n=v.polynomial(n);const s=v.monomial(t,1),[a,u]=v.euclidian(s,n,t),c=G(v.degree(a),0);let d=0;for(let l=1;l<256&&d<c.length;l++)v.evalPoly(a,l)===0&&(c[d++]=v.inv(l));if(d!==c.length)throw new Error("RS.decode: invalid errors number");for(let l=0;l<c.length;l++){const f=r.length-1-v.log(c[l]);if(f<0)throw new Error("RS.decode: invalid error location");const h=v.inv(c[l]);let g=1;for(let y=0;y<c.length;y++)l!==y&&(g=v.mul(g,v.add(1,v.mul(c[y],h))));r[f]=v.add(r[f],v.mul(v.evalPoly(u,h),v.inv(g)))}return r}}}function si(t,e){const{words:r,shortBlocks:i,numBlocks:n,blockLen:o,total:s}=P.capacity(t,e),a=oi(r);return{encode(u){const c=[],d=[];for(let g=0;g<n;g++){const y=g<i,w=o+(y?0:1);c.push(u.subarray(0,w)),d.push(a.encode(u.subarray(0,w))),u=u.subarray(w)}const l=Pe(c),f=Pe(d),h=new Uint8Array(l.length+f.length);return h.set(l),h.set(f,l.length),h},decode(u){if(u.length!==s)throw new Error(`interleave.decode: len(data)=${u.length}, total=${s}`);const c=[];for(let f=0;f<n;f++){const h=f<i;c.push(new Uint8Array(r+o+(h?0:1)))}let d=0;for(let f=0;f<o;f++)for(let h=0;h<n;h++)c[h][f]=u[d++];for(let f=i;f<n;f++)c[f][o]=u[d++];for(let f=o;f<o+r;f++)for(let h=0;h<n;h++){const g=h<i;c[h][f+(g?0:1)]=u[d++]}const l=[];for(const f of c)l.push(...Array.from(a.decode(f)).slice(0,-r));return Uint8Array.from(l)}}}function ai(t,e,r,i=!1){const n=P.size.encode(t);let o=new D(n+2);const s=new D(3).rect(0,3,!0).border(1,!1).border(1,!0).border(1,!1);o=o.embed(0,s).embed({x:-s.width,y:0},s).embed({x:0,y:-s.height},s),o=o.rectSlice(1,n);const a=new D(1).rect(0,1,!0).border(1,!1).border(1,!0),u=P.alignmentPatterns(t);for(const c of u)for(const d of u)o.isDefined(d,c)||o.embed({x:d-2,y:c-2},a);o=o.hLine({x:0,y:6},1/0,({x:c})=>o.isDefined(c,6)?void 0:c%2==0).vLine({x:6,y:0},1/0,({y:c})=>o.isDefined(6,c)?void 0:c%2==0);{const c=P.formatBits(e,r),d=l=>!i&&(c>>l&1)==1;for(let l=0;l<6;l++)o.set(8,l,d(l));for(let l=6;l<8;l++)o.set(8,l+1,d(l));for(let l=8;l<15;l++)o.set(8,n-15+l,d(l));for(let l=0;l<8;l++)o.set(n-l-1,8,d(l));for(let l=8;l<9;l++)o.set(15-l-1+1,8,d(l));for(let l=9;l<15;l++)o.set(15-l-1,8,d(l));o.set(8,n-8,!i)}if(t>=7){const c=P.versionBits(t);for(let d=0;d<18;d+=1){const l=!i&&(c>>d&1)==1,f=Math.floor(d/3),h=d%3+n-8-3;o.set(h,f,l),o.set(f,h,l)}}return o}function ui(t,e,r){const i=t.height,n=_e[e];let o=-1,s=i-1;for(let a=i-1;a>0;a-=2){for(a==6&&(a=5);;s+=o){for(let u=0;u<2;u+=1){const c=a-u;t.isDefined(c,s)||r(c,s,n(c,s))}if(s+o<0||s+o>=i)break}o=-o}}function li(t){let e="numeric";for(let r of t)if(!P.alphabet.numeric.has(r)&&(e="alphanumeric",!P.alphabet.alphanumerc.has(r)))return"byte";return e}function ci(t){if(typeof t!="string")throw new Error(`utf8ToBytes expected string, got ${typeof t}`);return new Uint8Array(new TextEncoder().encode(t))}function Le(t,e,r,i,n=ci){let o="",s=r.length;if(i==="numeric"){const f=P.alphabet.numeric.decode(r.split("")),h=f.length;for(let g=0;g<h-2;g+=3)o+=X(f[g]*100+f[g+1]*10+f[g+2],10);h%3===1?o+=X(f[h-1],4):h%3===2&&(o+=X(f[h-2]*10+f[h-1],7))}else if(i==="alphanumeric"){const f=P.alphabet.alphanumerc.decode(r.split("")),h=f.length;for(let g=0;g<h-1;g+=2)o+=X(f[g]*45+f[g+1],11);h%2==1&&(o+=X(f[h-1],6))}else if(i==="byte"){const f=n(r);s=f.length,o=Array.from(f).map(h=>X(h,8)).join("")}else throw new Error("encode: unsupported type");const{capacity:a}=P.capacity(t,e),u=X(s,P.lengthBits(t,i));let c=P.modeBits[i]+u+o;if(c.length>a)throw new Error("Capacity overflow");c+="0".repeat(Math.min(4,Math.max(0,a-c.length))),c.length%8&&(c+="0".repeat(8-c.length%8));const d="1110110000010001";for(let f=0;c.length!==a;f++)c+=d[f%d.length];const l=Uint8Array.from(c.match(/(.{8})/g).map(f=>+`0b${f}`));return si(t,e).encode(l)}function Be(t,e,r,i,n=!1){const o=ai(t,e,i,n);let s=0;const a=8*r.length;if(ui(o,i,(u,c,d)=>{let l=!1;s<a&&(l=(r[s>>>3]>>(7-s&7)&1)!==0,s++),o.set(u,c,l!==d)}),s!==a)throw new Error("QR: bytes left after draw");return o}const Ye=t=>{const e=t.map(r=>r?"1":"0").join("");return{len:e.length,n:+`0b${e}`}},Xe=[!0,!1,!0,!0,!0,!1,!0],Ze=[!1,!1,!1,!1],le=Ye([...Xe,...Ze]),Fe=Ye([...Ze,...Xe]);function fi(t){const{width:e,height:r}=t,i=t.transpose();let n=0;for(let d=0;d<r;d++)t.getRuns(d,l=>{l>=5&&(n+=3+(l-5))});for(let d=0;d<e;d++)i.getRuns(d,l=>{l>=5&&(n+=3+(l-5))});let o=0;for(let d=0;d<r-1;d++)o+=3*t.countBoxes2x2(d);let s=0;for(let d=0;d<r;d++)s+=40*t.countPatternInRow(d,le.len,le.n,Fe.n);for(let d=0;d<e;d++)s+=40*i.countPatternInRow(d,le.len,le.n,Fe.n);let a=0;a=t.popcnt();const u=a/(r*e)*100,c=10*Math.floor(Math.abs(u-50)/5);return n+o+s+c}function di(t,e,r,i){if(i===void 0){const n=ti();for(let o=0;o<_e.length;o++)n.add(fi(Be(t,e,r,o,!0)),o);i=n.get()}if(i===void 0)throw new Error("Cannot find mask");return Be(t,e,r,i)}function hi(t){if(!Ue.includes(t))throw new Error(`Invalid error correction mode=${t}. Expected: ${Ue}`)}function pi(t){if(!je.includes(t))throw new Error(`Encoding: invalid mode=${t}. Expected: ${je}`);if(t==="kanji"||t==="eci")throw new Error(`Encoding: ${t} is not supported (yet?).`)}function mi(t){if(![0,1,2,3,4,5,6,7].includes(t)||!_e[t])throw new Error(`Invalid mask=${t}. Expected number [0..7]`)}function yi(t,e="raw",r={}){const i=r.ecc!==void 0?r.ecc:"medium";hi(i);const n=r.encoding!==void 0?r.encoding:li(t);pi(n),r.mask!==void 0&&mi(r.mask);let o=r.version,s,a=new Error("Unknown error");if(o!==void 0)ei(o),s=Le(o,i,t,n,r.textEncoder);else for(let d=1;d<=40;d++)try{s=Le(d,i,t,n,r.textEncoder),o=d;break}catch(l){a=l}if(!o||!s)throw a;let u=di(o,i,s,r.mask);u.assertDrawn();const c=r.border===void 0?2:r.border;if(!Number.isSafeInteger(c))throw new Error(`invalid border type=${typeof c}`);if(u=u.border(c,!1),r.scale!==void 0&&(u=u.scale(r.scale)),e==="raw")return u.toRaw();if(e==="ascii")return u.toASCII();if(e==="svg")return u.toSVG(r.optimize);if(e==="gif")return u.toGIF();if(e==="term")return u.toTerm();throw new Error(`Unknown output: ${e}`)}const vi=W("matter",()=>{const t=J(),e=N({fabricCount:0,latestStatus:void 0}),r=N({qrCodeMatrix:null,manualCode:"",availableUntil:null,showModal:!1,expiresInMs:0,timeout:null});async function i(){await t.busyBar.SmartHomePairingGet().then(s=>{e.value.fabricCount=s.fabric_count||0,e.value.latestStatus=s.latest_pairing_status}).catch(async s=>{await S(s,"Couldn't get Matter commissioning status",!0)})}async function n(){await t.busyBar.SmartHomePair().then(s=>{r.value.manualCode=s.manual_code||"",r.value.availableUntil=new Date(Number(s.available_until)),r.value.timeout&&clearTimeout(r.value.timeout),r.value.expiresInMs=r.value.availableUntil.getTime()-Date.now(),r.value.qrCodeMatrix=yi(s.qr_code,"raw"),r.value.timeout=setTimeout(()=>{r.value.showModal=!1,r.value.qrCodeMatrix=null,r.value.manualCode="",r.value.availableUntil=null,r.value.timeout=null,console.debug("Matter commissioning link expired")},r.value.expiresInMs),r.value.showModal=!0}).catch(async s=>{await S(s,"Couldn't request Matter commissioning link")})}async function o(){await t.busyBar.SmartHomeErase().then(()=>{console.debug("All Matter pairings deleted, waiting for device to reboot")}).catch(async s=>{console.error(s.message),!s.message.includes("timed out")&&await S(s,"Couldn't delete pairings")})}return{matterCommissioning:e,matterLink:r,fetchMatterCommissioning:i,requestMatterLink:n,deleteAllPairings:o}}),gi=W("timezone",()=>{const t=J(),e=N(void 0);async function r(){return await t.busyBar.TimeTimezoneGet().then(o=>(e.value=o.name,o.name)).catch(async o=>(await S(o,"Couldn't get timezone",!0),e.value))}async function i(n){return await t.busyBar.TimeTimezoneSet({timezone:n}).then(()=>(e.value=n,!0)).catch(async o=>(await S(o,"Couldn't set timezone"),!1))}return{timezone:e,fetchTimezone:r,setTimezone:i}}),bi=W("screenStream",()=>({currentFrame:N(null)}),{persist:!1});function pe(t){return!!t&&typeof t=="object"&&!Array.isArray(t)&&!(t instanceof Uint8Array)}function Ei(t){return pe(t)&&"from"in t&&"to"in t&&Object.keys(t).length===2}function ce(t){if(typeof t=="string")return t;if(t===void 0)return"undefined";if(t===null)return"null";if(typeof t=="number"||typeof t=="boolean"||typeof t=="bigint")return String(t);try{return JSON.stringify(t)}catch{return String(t)}}function we(t,e){if(t!==e){if(pe(t)&&pe(e)){const r=new Set([...Object.keys(t),...Object.keys(e)]),i={};for(const n of r){const o=we(t[n],e[n]);o!==void 0&&(i[n]=o)}return Object.keys(i).length?i:void 0}if(Array.isArray(t)&&Array.isArray(e)){const r=Math.max(t.length,e.length),i=[];let n=!1;for(let o=0;o<r;o++){const s=we(t[o],e[o]);s!==void 0&&(i[o]=s,n=!0)}return n?i:void 0}return{from:t,to:e}}}function Ae(t,e=""){return t===void 0?[]:Ei(t)?[`${e||"value"}: ${ce(t.from)} -> ${ce(t.to)}`]:Array.isArray(t)?t.flatMap((r,i)=>Ae(r,`${e}[${i}]`)):pe(t)?Object.entries(t).flatMap(([r,i])=>{const n=e?`${e}.${r}`:r;return Ae(i,n)}):e?[`${e}: ${ce(t)}`]:[ce(t)]}function wi(t){switch(t){case k.WifiSecurity.OPEN:return"Open";case k.WifiSecurity.WPA:return"WPA";case k.WifiSecurity.WPA2:return"WPA2";case k.WifiSecurity.WEP:return"WEP";case k.WifiSecurity.WPA_WPA2:return"WPA/WPA2";case k.WifiSecurity.WPA3:return"WPA3";case k.WifiSecurity.WPA2_WPA3:return"WPA2/WPA3";default:return}}function Ai(t){switch(t){case k.IpConfigurationMethod.DHCP:return"dhcp";case k.IpConfigurationMethod.STATIC:return"static";default:return}}function _i(t){switch(t){case k.IpProtocol.IPV4:return"ipv4";case k.IpProtocol.IPV6:return"ipv6";default:return}}function Ri(t){if(t){if(t.includes(":"))return"ipv6";if(t.includes("."))return"ipv4"}}function Ti(t){switch(t){case k.MatterCommissioningStatus.NEVER_STARTED:return"never_started";case k.MatterCommissioningStatus.STARTED:return"started";case k.MatterCommissioningStatus.COMPLETED_SUCCESSFULLY:return"completed_successfully";case k.MatterCommissioningStatus.FAILED:return"failed";default:return}}const Qe=W("stateStream",()=>{const t=ne(),e=J(),r=Xr(),i=Zr(),n=Ee(),o=vi(),s=gi(),a=et(),u=bi(),c=me().public.barUrl||window.location.origin,d=N(!1),l=N(!1),f=N(!1),h=We(new Hr({addr:c,token:t.apiKey||""},{timeout:5e3,dataTimeout:1500,maxReconnectAttempts:5,reconnectDelay:250})),g=N(null),y=N(!0);function w(){h.value.stop(),g.value?.data.status===B.STALE&&(g.value.data.status=B.NONE),y.value=!0}function _(A){const m=A.name;m&&(e.deviceName=m)}function p(A){const m=A.known,E=m?{state:m.batteryStatus?k.BatteryStatus[m.batteryStatus]:void 0,battery_charge:m.batteryChargePercent??0,battery_voltage:m.batteryVoltageMv??0,battery_current:m.batteryCurrentMa??0,usb_voltage:m.usbVoltageMv??0}:void 0;E&&(e.deviceStatus={...e.deviceStatus,power:E})}function b(A){if(A.automatic){i.displayBrightness={value:"auto"};return}const m=A.manual?.brightness;m!==void 0?i.displayBrightness={value:m}:i.displayBrightness={value:0}}function I(A){const m=A.volume;m!==void 0?r.audio={volume:m??0}:r.audio={volume:0}}function H(A){const m=Object.keys(A).filter(V=>V!=="ipAddresses")[0],E=A.connected,R=(Array.isArray(A.ipAddresses)?A.ipAddresses:[]).find(V=>V.address),te=a.wifi?.ip_config,q=R?R.address:void 0;let C=m;m==="connected"&&E?.status===k.WifiConnectionStatus.RECONNECTING&&(C="reconnecting");const M={state:C,ssid:E?.ssid,bssid:E?.bssid,channel:E?.channel,rssi:E?.rssi,security:wi(E?.security),ip_config:R?{ip_method:Ai(R.method)??te?.ip_method,ip_type:_i(R.protocol)??Ri(q)??te?.ip_type,address:q,gateway:R.gateway,mask:R.netmask}:void 0},Y=a.wifi?.state;a.wifi=M,Y!==M.state&&(M.state==="connected"?window.dispatchEvent(new Event("wifi-reconnected")):Y==="connected"&&window.dispatchEvent(new Event("wifi-disconnected")))}function $(A){if(n.autoUpdate.isChecking=!1,A.available){n.autoUpdate.status="available",n.autoUpdate.availableVersion=A.available?.version??null,n.autoUpdate.isAllowed=!0;return}const m=A.unavailable?.reason;if(n.autoUpdate.availableVersion=null,m===he.CheckError.NOT_AVAILABLE){n.autoUpdate.status="not_available",n.autoUpdate.isAllowed=!0;return}if(m===he.CheckError.FAILURE){n.autoUpdate.status="failure",n.autoUpdate.isAllowed=!1;return}n.autoUpdate.status=null}function U(A){A.name&&(s.timezone=A.name)}function F(A){const m=A.state;o.matterCommissioning={fabricCount:A.fabricCount??0,latestStatus:m?{value:Ti(m.status),timestamp:m.timestamp??0}:void 0}}function K(A){if(A.updates)for(const m of A.updates)switch(m.state){case"deviceName":m.deviceName&&_(m.deviceName);break;case"power":m.power&&p(m.power);break;case"brightness":m.brightness&&b(m.brightness);break;case"audioVolume":m.audioVolume&&I(m.audioVolume);break;case"wifi":m.wifi&&H(m.wifi);break;case"updateCheck":m.updateCheck&&$(m.updateCheck);break;case"timezone":m.timezone&&U(m.timezone);break;case"matter":m.matter&&F(m.matter);break;case"frame":m.frame&&(u.currentFrame=m.frame);break}}async function ee(A){const m=g.value;if(m===null){g.value=A,console.debug("[state stream status] Initial stream status:",A);return}const E=we(m,A);if(E)for(const O of Ae(E))console.debug("[state stream status]",O,"| full status:",A);g.value=A,g.value.data.status===B.STALE&&m?.data.status!==B.STALE&&y.value&&(console.debug("No state messages received for a while, checking connection..."),await e.checkConnection()===!1&&(console.debug("Connection check failed after state stream data stale, stopping stream and starting polling"),w(),e.setRefreshInterval()))}return{streamNotRestartable:d,showStateStreamFailBanner:l,showResourceLimitErrorBanner:f,streamStatus:g,stream:h,doCheckConnectionOnStreamDataStale:y,stopStream:w,applyStateMessage:K,applyStreamStatus:ee}}),Si=W("config",()=>({refreshDeviceDataAbortIfStreamActive:N(!0)}),{persist:{key:"configStore",storage:Me.localStorage()}}),J=W("device",()=>{const t=ne().apiRequest,e=et(),r=Ee(),i=Qe(),n=We(new ze({addr:me().public.barUrl||window.location.origin})),o=N(!0),s=N(!1),a=N(0);async function u(){if(s.value)return"aborted";o.value&&a.value>=3&&(console.warn("Data has been stale for a while and multiple connection checks have succeeded, restarting state stream as it seems to be in a bad state"),i.stopStream(),a.value=0,window.dispatchEvent(new Event("protobuf-websocket-restart"))),s.value=!0;const m=o.value;try{await t("/api/name",{timeout:3e3}),o.value||(window.dispatchEvent(new Event("device-reconnected")),r.autoUpdate.stage===z.UPDATING&&(r.autoUpdate.stage=z.SUCCESS)),o.value=!0,console.debug("Device is connected"),L.remove("device-disconnected")}catch(E){if(!c.value&&i.streamStatus?.data.status===B.ACTIVE){console.debug("conncheck request aborted, ignoring because refresh interval is cleared and stream data is active");const O=E;if(O?.name==="AbortError"||O?.message?.toLowerCase().includes("abort")||O?.code==="ECONNABORTED")return s.value=!1,"aborted"}m&&window.dispatchEvent(new Event("device-disconnected")),o.value=!1,console.debug("Device is disconnected"),r.autoUpdate.stage!==z.UPDATING&&!(r.autoUpdate.stage===z.SUCCESS&&e.wifi?.state!=="connected")&&(r.fileUpdate.stage===z.IDLE||r.fileUpdate.stage===z.ERROR)&&L.add({id:"device-disconnected",title:"Device disconnected",description:"Device lost. Please check the connection.",icon:"i-bi-alert",color:"warning",duration:0,close:!0,closeIcon:"i-bi-cross"})}return s.value=!1,o.value&&i.streamStatus?.data.status===B.STALE?a.value++:a.value=0,o.value}const c=N();async function d(){if(Si().refreshDeviceDataAbortIfStreamActive&&(console.debug("Checking whether to refresh device data. Stream status:",i.streamStatus),i.streamStatus?.main.status===x.RUNNING&&i.streamStatus?.data.status===B.ACTIVE)){console.debug("Skipping device data refresh because stream is active and config is set to abort in this case"),c.value&&(clearInterval(c.value),c.value=void 0,console.debug("Cleared refresh interval to stop refreshing device data while stream is active"));return}const E=Ee();if(E.autoUpdate.stage===z.LOADING||E.fileUpdate.stage===z.LOADING){console.debug("Skipping connection check during auto update");return}if(await u(),!o.value)return;L.remove("device-disconnected"),await p();const O=e.wifi?.state,R=await e.fetchWifiState();O!==R?.state&&(R?.state==="connected"?window.dispatchEvent(new Event("wifi-reconnected")):window.dispatchEvent(new Event("wifi-disconnected"))),await F()}function l(){c.value=be(d,5e3)}function f(){c.value&&(clearInterval(c.value),c.value=void 0)}const h=N("wifi");async function g(){await n.value.SystemTransportGet().then(m=>{h.value=m.type,console.debug("Detected connection type:",h.value)}).catch(async m=>(await S(m,"Couldn't get connection type",!0),h.value))}const y=N(void 0);async function w(){return await n.value.SystemVersionGet().then(E=>(y.value=E,E)).catch(async E=>(await S(E,"Couldn't get HTTP API version",!0),y.value))}const _=N(void 0);async function p(){return await n.value.SystemStatusGet().then(E=>(_.value=E,E)).catch(async E=>(await S(E,"Couldn't get device status",!0),_.value))}const b="BUSY Bar",I=N(void 0);async function H(m=!1){return await n.value.SettingsNameGet().then(O=>(I.value=O.name,O.name)).catch(async O=>{if(m)throw O;return await S(O,"Couldn't get device name"),b})}async function $(m){return await n.value.SettingsNameSet({name:m}).then(()=>(I.value=m,L.add({title:"Changes saved",icon:"i-bi-checkmark-circle-fill",color:"success"}),!0)).catch(async E=>(await S(E,"Couldn't set device name"),!1))}const U=N(void 0);async function F(){return await n.value.SettingsAccessGet().then(E=>(U.value=E,E)).catch(async E=>(await S(E,"Couldn't get HTTP API access state",!0),U.value))}async function K(m,E){const O={mode:m};if(m==="key"){if(!E)throw new Error("Password not provided");O.key=E}return await n.value.SettingsAccessSet(O).then(async()=>(U.value=await F(),L.add({title:m==="key"?"Password set":"Changes saved",icon:"i-bi-checkmark-circle-fill",color:"success"}),!0)).catch(async R=>(await S(R,"Couldn't set HTTP API access state"),!1))}const ee=N(null);async function A(){return await n.value.AccountInfoGet().then(E=>(ee.value=E,E)).catch(async E=>(await S(E,"Couldn't get account info",!0),null))}return{busyBar:n,isConnected:o,checkConnection:u,connectionType:h,detectConnectionType:g,refreshInterval:c,setRefreshInterval:l,clearRefreshInterval:f,apiVersion:y,fetchApiVersion:w,deviceStatus:_,fetchDeviceStatus:p,deviceName:I,fetchDeviceName:H,setDeviceName:$,httpAPIAccess:U,fetchHttpAPIAccess:F,setHttpAPIAccess:K,accountInfo:ee,fetchAccountInfo:A}}),et=W("wifi",()=>{const t=J(),e=Qe(),r=N(void 0);async function i(){return await t.busyBar.WifiStatusGet().then(u=>(r.value=u,u)).catch(async u=>(await S(u,"Couldn't fetch WiFi state",!0),r.value))}async function n(){const a=t.refreshInterval;return a&&t.clearRefreshInterval(),e.doCheckConnectionOnStreamDataStale=!1,await t.busyBar.WifiNetworksGet({timeout:45e3}).then(u=>{if(!u||!Array.isArray(u.networks))throw new Error("Failed to fetch WiFi networks");return u.networks=u.networks.reduce((c,d)=>{const l=c.find(f=>f.ssid===d.ssid);if(!l)c.push(d);else if(d.rssi&&l.rssi&&d.rssi<l.rssi){const f=c.indexOf(l);c[f]=d}return c},[]),u.networks}).catch(async u=>{if(r.value?.state!=="connected")return await S(u,"Couldn't list WiFi networks",!1,0),[]}).finally(()=>{e.doCheckConnectionOnStreamDataStale=!0,a&&(console.debug("wifiStore.listWifiNetworks: was polling before, resuming polling"),t.setRefreshInterval())})}async function o(a){const u=t.refreshInterval;return u&&t.clearRefreshInterval(),e.doCheckConnectionOnStreamDataStale=!1,await t.busyBar.WifiConnect({...a,timeout:45e3}).catch(async c=>(await S(c,"Couldn't connect to WiFi network",!1,0),!1)).finally(()=>{e.doCheckConnectionOnStreamDataStale=!0,u&&(console.debug("wifiStore.connectToWifiNetwork: was polling before, resuming polling"),t.setRefreshInterval())})}async function s(){const a=t.refreshInterval;return a&&t.clearRefreshInterval(),e.doCheckConnectionOnStreamDataStale=!1,await t.busyBar.WifiDisconnect().catch(async u=>(await S(u,"Couldn't disconnect from WiFi network",!1,0),!1)).finally(()=>{e.doCheckConnectionOnStreamDataStale=!0,a&&(console.debug("wifiStore.disconnectFromWifiNetwork: was polling before, resuming polling"),t.setRefreshInterval())})}return{wifi:r,fetchWifiState:i,listWifiNetworks:n,connectToWifiNetwork:o,disconnectFromWifiNetwork:s}});export{Ie as D,Ni as N,z as U,J as a,Ee as b,Xr as c,Zr as d,gi as e,vi as f,ne as g,S as h,bi as i,Qe as j,Ne as k,Si as l,j as m,x as n,be as s,L as t,et as u};
