...
void furi_hal_i2c_init_early(void) {
    furi_hal_i2c_bus_1.callback(&furi_hal_i2c_bus_1, FuriHalI2cBusEventInit);
}

void furi_hal_i2c_deinit_early(void) {
    furi_hal_i2c_bus_1.callback(&furi_hal_i2c_bus_1, FuriHalI2cBusEventDeinit);
}
...
void furi_hal_i2c_acquire(FuriHalI2cBusHandle* handle) {
    // furi_hal_power_insomnia_enter(); TODO:
    // Lock bus access
