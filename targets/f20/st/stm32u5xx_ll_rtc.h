...
#define LL_RTC_ALMA_SUBSECONDBIN_AUTOCLR_YES \
    RTC_ALRMASSR_SSCLR /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRMABINR -> SS[31:0] value and is automatically reloaded with 0xFFFF FFFF when reaching RTC_ALRMABINR -> SS[31:0]. */
/**
  * @}
  */
...
#define LL_RTC_ALMB_SUBSECONDBIN_AUTOCLR_YES \
    RTC_ALRMBSSR_SSCLR /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to RTC_ALRMABINR -> SS[31:0] value and is automatically reloaded with 0xFFFF FFFF when reaching RTC_ALRMABINR -> SS[31:0]. */
/**
  * @}
  */
...
#define LL_RTC_TAMPER_MASK_TAMPER1 \
    TAMP_CR2_TAMP1MSK /*!< Tamper 1 event generates a trigger event. TAMP1F is masked and internally cleared by hardware.The backup registers are not erased */
#define LL_RTC_TAMPER_MASK_TAMPER2 \
    TAMP_CR2_TAMP2MSK /*!< Tamper 2 event generates a trigger event. TAMP2F is masked and internally cleared by hardware. The backup registers are not erased. */
#define LL_RTC_TAMPER_MASK_TAMPER3 \
    TAMP_CR2_TAMP3MSK /*!< Tamper 3 event generates a trigger event. TAMP2F is masked and internally cleared by hardware. The backup registers are not erased. */
/**
  * @}
  */
...
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP1 \
    TAMP_CR2_TAMP1TRG /*!< Tamper 1 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP2 \
    TAMP_CR2_TAMP2TRG /*!< Tamper 2 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3 \
    TAMP_CR2_TAMP3TRG /*!< Tamper 3 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP4 \
    TAMP_CR2_TAMP4TRG /*!< Tamper 4 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP5 \
    TAMP_CR2_TAMP5TRG /*!< Tamper 5 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP6 \
    TAMP_CR2_TAMP6TRG /*!< Tamper 6 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP7 \
    TAMP_CR2_TAMP7TRG /*!< Tamper 7 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP8 \
    TAMP_CR2_TAMP8TRG /*!< Tamper 8 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a tamper detection event */
/**
  * @}
  */
...
#define LL_RTC_TAMPER_ITAMP7 \
    TAMP_CR1_ITAMP7E /*!< Internal tamper 7: ADC4 analog watchdog monitoring 1 */
...
#define LL_RTC_TAMPER_ITAMP12 \
    TAMP_CR1_ITAMP12E /*!< Internal tamper 12: ADC4 analog watchdog monitoring 2*/
#define LL_RTC_TAMPER_ITAMP13 \
    TAMP_CR1_ITAMP13E /*!< Internal tamper 13: ADC4 analog watchdog monitoring 3 */
/**
  * @}
  */
...
#define LL_RTC_UNSECURE_FEATURE_INIT \
    ~RTC_SECCFGR_INITSEC /*!< Initialization feature is not secure */
...
#define LL_RTC_PRIVILEGE_FULL_NO \
    0U /*!< RTC is not full privilege, features can be unprivilege. See RTC_LL_EC_PRIVILEGE_RTC_FEATURE */
/**
  * @}
  */
...
__STATIC_INLINE void LL_RTC_ALMA_SetMask(RTC_TypeDef* RTCx, uint32_t Mask) {
    MODIFY_REG(
        RTCx->ALRMAR, RTC_ALRMAR_MSK4 | RTC_ALRMAR_MSK3 | RTC_ALRMAR_MSK2 | RTC_ALRMAR_MSK1, Mask);
}
...
__STATIC_INLINE void LL_RTC_ALMB_SetMask(RTC_TypeDef* RTCx, uint32_t Mask) {
    MODIFY_REG(
        RTCx->ALRMBR, RTC_ALRMBR_MSK4 | RTC_ALRMBR_MSK3 | RTC_ALRMBR_MSK2 | RTC_ALRMBR_MSK1, Mask);
}
...
/**
  ...
  */
__STATIC_INLINE void
    LL_RTC_TAMPER_SetSamplingFreq(const RTC_TypeDef* RTCx, uint32_t SamplingFreq) {
    UNUSED(RTCx);
...
/**
  ...
  */
__STATIC_INLINE void
    LL_RTC_TAMPER_ITAMP_Disable(const RTC_TypeDef* RTCx, uint32_t InternalTamper) {
    UNUSED(RTCx);
...
/**
  ...
  */
__STATIC_INLINE void
    LL_RTC_BKP_SetRegister(const RTC_TypeDef* RTCx, uint32_t BackupRegister, uint32_t Data) {
    __IO uint32_t tmp;
...
/**
  ...
  */
__STATIC_INLINE void
    LL_RTC_SetBackupRegisterPrivilege(const RTC_TypeDef* RTCx, uint32_t bckupRegisterPrivilege) {
    UNUSED(RTCx);
    MODIFY_REG(
        TAMP->PRIVCFGR,
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetBackupRegProtection(
    const RTC_TypeDef* RTCx,
    uint32_t startZone2,
    uint32_t startZone3) {
    UNUSED(RTCx);
    MODIFY_REG(
