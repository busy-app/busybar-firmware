...
__attribute__((always_inline)) static inline uint32_t _osal_ms2tick(uint32_t msec) {
...
__attribute__((always_inline)) static inline osal_semaphore_t
...
__attribute__((always_inline)) static inline osal_mutex_t
...
__attribute__((always_inline)) static inline osal_queue_t
