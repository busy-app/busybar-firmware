...
void furi_hal_clock_init(void) {
    ...
    //ToDo: It may be necessary to call the function again when using the power saving mode.
    furi_check(furi_hal_qspi_flash_clk_config(M4CLK, QSPI_INTFPLLCLK, 0, 0, 1) == RSI_OK);
