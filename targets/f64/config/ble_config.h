...
#define RSI_BLE_NUM_CONN_EVENTS     5 //ToDo: Need to check
...
/* Number of BLE GATT RECORD SIZE IN (n*16 BYTES), eg:(0x50*16)=1280 bytes */
#define RSI_BLE_NUM_REC_BYTES 0x50
