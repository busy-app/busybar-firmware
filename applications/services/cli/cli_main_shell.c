...
void cli_main_motd(void* context) {
    ...
    printf(ANSI_FLIPPER_BRAND_ORANGE
           ...
           "|  " ANSI_FG_BR_RED "| _ \\ |_| \\__ \\\\ V /    " ANSI_FG_BR_GREEN "> CLI    " ANSI_FLIPPER_BRAND_ORANGE "|\r\n"
           "|  " ANSI_FG_BR_RED "|___/\\___/|___/ |_|              " ANSI_FLIPPER_BRAND_ORANGE "|\r\n"
           " \\_________________________________/\r\n"
           "\r\n" ANSI_FG_BR_WHITE "Welcome to BUSY Bar " ANSI_FG_BR_YELLOW "U5" ANSI_FG_BR_WHITE " Command Line Interface!\r\n"
