 ...
 * @param[in] sub_label zero-terminated string containing the auxiliary item text (may be @c NULL)
 * @param[in] icon_source zero-terminated string containing a full path to the icon file
