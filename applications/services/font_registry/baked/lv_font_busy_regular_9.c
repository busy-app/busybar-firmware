 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --font busy_regular_9px.ttf -o ../../../../applications/services/font_registry/baked/lv_font_busy_regular_9.c --bpp 1 --size 16 --no-compress --format lvgl --range 0-65535
 ******************************************************************************/
