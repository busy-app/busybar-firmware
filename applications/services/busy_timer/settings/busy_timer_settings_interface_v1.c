...
typedef enum {
    ...
    BusyTimerSettingsV1AppConfigIdxShowTimeLeft,
...
static const SettingProviderSetting busy_timer_settings_v1_app_config[] = {
    ...
    [BusyTimerSettingsV1AppConfigIdxShowTimeLeft] =
        {
            .name = "is_show_time_left_enabled",
            .interface =
                &(const SettingProviderBoolInterface){
                    .default_value = BUSY_APP_IS_SHOW_TIME_LEFT_ENABLED_DEFAULT,
                },
            .field_offset = offsetof(BusyAppConfig, is_show_time_left_enabled),
            .type = SettingProviderSettingTypeBool,
        },
};
