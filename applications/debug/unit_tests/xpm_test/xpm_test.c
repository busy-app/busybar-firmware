...
MU_TEST(xpm_header_too_few_numbers) {
    Xpm* xpm = xpm_alloc("8 8 2\n.c #FF0000\n#c #00FF00\n");
    mu_check(!xpm_decode_header(xpm));
    xpm_free(xpm);
}

MU_TEST(xpm_header_invalid_value) {
    Xpm* xpm = xpm_alloc("8 8 0 1\n.c #FF0000\n");
    mu_check(!xpm_decode_header(xpm));
    xpm_free(xpm);
}

MU_TEST(xpm_header_garbage_after_numbers) {
    Xpm* xpm = xpm_alloc("8 8 2 1 garbage\n.c #FF0000\n");
    mu_check(!xpm_decode_header(xpm));
    xpm_free(xpm);
}

MU_TEST(xpm_colors_single_hex) {
    Xpm* xpm = xpm_alloc("1 1 1 1\n. c #FF0000\n.\n");
    mu_check(xpm_decode_header(xpm));
