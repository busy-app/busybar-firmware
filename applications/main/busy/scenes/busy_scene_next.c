...
static void busy_scene_next_on_enter(void* context) {
    ...
    BusyApp* instance = context;
    BusySceneNext* data = scene_manager_get_scene_data(instance->scene_manager, BusyAppSceneIdNext);
...
static bool busy_scene_next_on_event(const SceneManagerEvent* event, void* context) {
    ...
    if(event->type == SceneManagerEventTypeCustom) {
        const BusySceneNext* data = scene_manager_get_scene_data(instance->scene_manager, BusyAppSceneIdNext);
