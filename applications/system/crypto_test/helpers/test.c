...
//     !defined(MBEDTLS_PEM_WRITE_C) || !defined(MBEDTLS_FS_IO) || !defined(MBEDTLS_MD_C)
// int main(void) {
...
//                     if(ip_addr_len == 0) {
//                         mbedtls_printf(
//                             "mbedtls_x509_crt_parse_cn_inet_pton failed to parse %s\n",
//                             subtype_value);
//                         goto exit;
//                     }
...
//                     if((ret = mbedtls_x509_string_to_names(&tmp_san_dirname, subtype_value)) !=
//                        0) {
