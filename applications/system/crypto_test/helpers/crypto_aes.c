...
const uint8_t key_const[32] = {'H', 'e', 'l', 'l', 'o', ' ', 'W', 'o', 'r', 'l', 'd',
                               '!', '!', '!', '!', '!', 'H', 'e', 'l', 'l', 'o', ' ',
                               'W', 'o', 'r', 'l', 'd', '!', '!', '!', '!', '!'}; // 256 bits key
...
void crypto_aes_test(CryptoTestApp* app, FuriString* msg) {
    crypto_aes_test_custom_size_key(app, msg, 16);
    crypto_aes_test_custom_size_key(app, msg, 24);
    crypto_aes_test_custom_size_key(app, msg, 32);
