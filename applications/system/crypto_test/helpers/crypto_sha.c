...
const uint8_t digest_out_sha1[FuriHalShaLengthSha1] = {0xa4, 0x9b, 0x24, 0x46, 0xa0, 0x2c, 0x64,
                                                       0x5b, 0xf4, 0x19, 0xf9, 0x95, 0xb6, 0x70,
                                                       0x91, 0x25, 0x3a, 0x04, 0xa2, 0x59};
const uint8_t digest_out_sha256[FuriHalShaLengthSha256] = {
...
const uint8_t digest_out_sha384[FuriHalShaLengthSha384] = {
...
const uint8_t digest_out_sha512[FuriHalShaLengthSha512] = {
...
const uint8_t digest_out_sha244[FuriHalShaLengthSha244] = {
...
void crypto_sha_print_buffer_char(
    CryptoTestApp* app,
    FuriString* msg,
    char* tag,
    uint8_t* buffer,
...
void crypto_sha_print_buffer_hex(
    CryptoTestApp* app,
    FuriString* msg,
    char* tag,
...
void crypto_sha_chek(
    ...
    FuriHalShaLength sha_length) {
    crypto_sha_print_buffer_hex(app, msg, "Message =\t\t", (uint8_t*)message, sizeof(message));
    crypto_sha_print_buffer_hex(app, msg, "Digest =\t\t", digest, sha_length);
    crypto_sha_print_buffer_hex(app, msg, "Expected =\t", digest_out, sha_length);
    if(memcmp(digest, digest_out, sha_length) != 0) {
...
void crypto_sha_test_custom_sha_mode(CryptoTestApp* app, FuriString* msg, FuriHalShaMode sha_mode) {
    ...
    uint8_t digest[FuriHalShaLengthSha512] = {0};
    furi_hal_sha(sha_mode, (uint8_t*)message, sizeof(message) - 1, digest);

    switch(sha_mode) {
    case FuriHalShaModeSha1:
        crypto_sha_chek(app, msg, "SHA1", digest, digest_out_sha1, FuriHalShaLengthSha1);
        break;
    case FuriHalShaModeSha256:
        crypto_sha_chek(app, msg, "SHA256", digest, digest_out_sha256, FuriHalShaLengthSha256);
        break;
    case FuriHalShaModeSha384:
        crypto_sha_chek(app, msg, "SHA384", digest, digest_out_sha384, FuriHalShaLengthSha384);
        break;
    case FuriHalShaModeSha512:
        crypto_sha_chek(app, msg, "SHA512", digest, digest_out_sha512, FuriHalShaLengthSha512);
        break;
    case FuriHalShaModeSha244:
        crypto_sha_chek(app, msg, "SHA224", digest, digest_out_sha244, FuriHalShaLengthSha244);
        break;
