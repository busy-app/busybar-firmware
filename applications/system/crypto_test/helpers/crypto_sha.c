...
static const uint8_t digest_out_sha1[FuriHalShaLengthSha1] = {0xa4, 0x9b, 0x24, 0x46, 0xa0,
                                                              0x2c, 0x64, 0x5b, 0xf4, 0x19,
                                                              0xf9, 0x95, 0xb6, 0x70, 0x91,
                                                              0x25, 0x3a, 0x04, 0xa2, 0x59};
static const uint8_t digest_out_sha256[FuriHalShaLengthSha256] = {
...
static const uint8_t digest_out_sha384[FuriHalShaLengthSha384] = {
...
static const uint8_t digest_out_sha512[FuriHalShaLengthSha512] = {
...
static const uint8_t digest_out_sha244[FuriHalShaLengthSha244] = {
...
void crypto_sha_chek(
    ...
    crypto_common_print_buffer_hex(app, msg, "Digest =\t\t", digest, sha_length);
    crypto_common_print_buffer_hex(app, msg, "Expected =\t", digest_out, sha_length);
