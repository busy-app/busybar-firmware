...
#define RSI_TCP_IP_FEATURE_BIT_MAP_PER_TEST 0 //! TCP/IP feature select bitmap for selecting TCP/IP features
...
static const sl_wifi_device_configuration_t config = {
    ...
    .boot_config = {
        ...
        .tcp_ip_feature_bit_map = RSI_TCP_IP_FEATURE_BIT_MAP_PER_TEST,
#else
        .tcp_ip_feature_bit_map =
            (RSI_TCP_IP_FEATURE_BIT_MAP_PER_TEST | SL_SI91X_TCP_IP_FEAT_EXTENSION_VALID),
#endif
