...
static void js_app_launcher_scene_error_on_enter(void* context) {
    ...
    with_gui(instance->gui, {
        ...
        status_view_set_primary_text(data->front_status, "Failed to start app");
        ...
        status_view_set_primary_text(data->back_status, "Error");
        status_view_set_auxiliary_text(data->back_status, "Failed to start app");
