...
static void firmware_settings_check_scene_prepare_up_to_date_result(FirmwareSettings* instance) {
    instance->check_result_preset.front_image_path = SHARED_IMG_PATH("checkmark_front_8x8.bin");
    furi_string_set(instance->check_result_preset.front_text, "Up to date");

    instance->check_result_preset.back_image_path = SHARED_IMG_PATH("checkmark_back_11x11.bin");
