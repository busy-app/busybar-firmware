...
static bool about_thread_signal_callback(uint32_t signal, void* arg, void* context) {
    UNUSED(arg);
    ...
    case FuriSignalAboutToExit:
        about_send_custom_event(instance, AppEventAboutToExit);
        return true;
...
static void about_input_queue_callback(FuriEventLoopObject* object, void* context) {
    UNUSED(object);
...
static void about_event_queue_callback(FuriEventLoopObject* object, void* context) {
    UNUSED(object);
...
static bool about_gui_input_callback(const InputEvent* event, void* context) {
    furi_assert(event);
    furi_assert(context);
...
static About* about_alloc() {
    ...
    instance->scene_manager = scene_manager_alloc(about_scenes, COUNT_OF(about_scenes), instance);
    ...
    with_gui(instance->gui, {
        ...
        gui_layer_add_input_callback(layer, about_gui_input_callback, instance);
        ...
        nav_bar_push_location(instance->back_nav_bar, "ABOUT");
...
static void about_free(About* instance) {
    furi_assert(instance);
    scene_manager_free(instance->scene_manager);

    with_gui(instance->gui, {
        GuiLayer* layer = gui_get_layer(instance->gui, GuiLayerIdMain);
        gui_layer_remove_input_callback(layer, about_gui_input_callback);
...
int32_t about_entry(void* arg) {
    if(arg) {
        ...
        furi_string_set_str(descriptor->front_title, "About device");
        furi_string_set_str(descriptor->back_title, "About device");
    ...
    About* instance = about_alloc();
    FuriThread* thread = furi_thread_get_current();
    furi_thread_set_signal_callback(thread, about_thread_signal_callback, instance);
