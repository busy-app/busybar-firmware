...
static void about_scene_firmware_on_enter(void* context) {
    ...
    furi_string_printf(
        scene->firmware_info_str, GREY_TEXT("Version:") " %s", version_get_version(version));
    furi_string_printf(
        scene->firmware_info_str, GREY_TEXT("Branch:") " %s", version_get_gitbranch(version));
    furi_string_printf(
        scene->firmware_info_str, GREY_TEXT("Commit hash:") " %s%%", version_get_githash(version));
